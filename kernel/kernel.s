...
c003002f:	e9 d4 12 00 00       	jmp    c0031308 <init>
...
c00300cc:	e8 90 0f 00 00       	call   c0031061 <irq_handle>
...
c00300dd:	83 ec 10             	sub    $0x10,%esp
c00300e0:	e8 01 02 00 00       	call   c00302e6 <__x86.get_pc_thunk.dx>
c00300e5:	81 c2 1b bf 00 00    	add    $0xbf1b,%edx
c00300eb:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
c00300f2:	eb 1b                	jmp    c003010f <cache_init+0x36>
c00300f4:	8b 4d f8             	mov    -0x8(%ebp),%ecx
c00300f7:	8d 9a 04 10 00 00    	lea    0x1004(%edx),%ebx
c00300fd:	89 c8                	mov    %ecx,%eax
c00300ff:	c1 e0 06             	shl    $0x6,%eax
c0030102:	01 c8                	add    %ecx,%eax
c0030104:	c1 e0 03             	shl    $0x3,%eax
c0030107:	01 d8                	add    %ebx,%eax
c0030109:	c6 00 00             	movb   $0x0,(%eax)
c003010c:	ff 45 f8             	incl   -0x8(%ebp)
c003010f:	83 7d f8 7f          	cmpl   $0x7f,-0x8(%ebp)
c0030113:	7e df                	jle    c00300f4 <cache_init+0x1b>
c0030115:	90                   	nop
...
c003011c <cache_writeback>:
c003011c:	55                   	push   %ebp
c003011d:	89 e5                	mov    %esp,%ebp
c003011f:	53                   	push   %ebx
c0030120:	83 ec 14             	sub    $0x14,%esp
c0030123:	e8 c2 01 00 00       	call   c00302ea <__x86.get_pc_thunk.bx>
c0030128:	81 c3 d8 be 00 00    	add    $0xbed8,%ebx
c003012e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c0030135:	eb 72                	jmp    c00301a9 <cache_writeback+0x8d>
c0030137:	8b 55 f4             	mov    -0xc(%ebp),%edx
c003013a:	8d 8b 05 10 00 00    	lea    0x1005(%ebx),%ecx
c0030140:	89 d0                	mov    %edx,%eax
c0030142:	c1 e0 06             	shl    $0x6,%eax
c0030145:	01 d0                	add    %edx,%eax
c0030147:	c1 e0 03             	shl    $0x3,%eax
c003014a:	01 c8                	add    %ecx,%eax
c003014c:	8a 00                	mov    (%eax),%al
c003014e:	3c 01                	cmp    $0x1,%al
c0030150:	75 54                	jne    c00301a6 <cache_writeback+0x8a>
c0030152:	8b 55 f4             	mov    -0xc(%ebp),%edx
c0030155:	8d 8b 00 10 00 00    	lea    0x1000(%ebx),%ecx
c003015b:	89 d0                	mov    %edx,%eax
c003015d:	c1 e0 06             	shl    $0x6,%eax
c0030160:	01 d0                	add    %edx,%eax
c0030162:	c1 e0 03             	shl    $0x3,%eax
c0030165:	01 c8                	add    %ecx,%eax
c0030167:	8b 10                	mov    (%eax),%edx
c0030169:	8b 4d f4             	mov    -0xc(%ebp),%ecx
c003016c:	89 c8                	mov    %ecx,%eax
c003016e:	c1 e0 06             	shl    $0x6,%eax
c0030171:	01 c8                	add    %ecx,%eax
c0030173:	c1 e0 03             	shl    $0x3,%eax
c0030176:	8d 8b 00 10 00 00    	lea    0x1000(%ebx),%ecx
c003017c:	01 c8                	add    %ecx,%eax
c003017e:	83 c0 06             	add    $0x6,%eax
c0030181:	83 ec 08             	sub    $0x8,%esp
c0030184:	52                   	push   %edx
c0030185:	50                   	push   %eax
c0030186:	e8 58 03 00 00       	call   c00304e3 <disk_do_write>
c003018b:	83 c4 10             	add    $0x10,%esp
c003018e:	8b 55 f4             	mov    -0xc(%ebp),%edx
c0030191:	8d 8b 05 10 00 00    	lea    0x1005(%ebx),%ecx
c0030197:	89 d0                	mov    %edx,%eax
c0030199:	c1 e0 06             	shl    $0x6,%eax
c003019c:	01 d0                	add    %edx,%eax
c003019e:	c1 e0 03             	shl    $0x3,%eax
c00301a1:	01 c8                	add    %ecx,%eax
c00301a3:	c6 00 00             	movb   $0x0,(%eax)
c00301a6:	ff 45 f4             	incl   -0xc(%ebp)
c00301a9:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
c00301ad:	7e 88                	jle    c0030137 <cache_writeback+0x1b>
c00301af:	90                   	nop
c00301b0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00301b3:	c9                   	leave  
c00301b4:	c3                   	ret    

c00301b5 <cache_fetch>:
c00301b5:	55                   	push   %ebp
c00301b6:	89 e5                	mov    %esp,%ebp
c00301b8:	53                   	push   %ebx
c00301b9:	83 ec 14             	sub    $0x14,%esp
c00301bc:	e8 29 01 00 00       	call   c00302ea <__x86.get_pc_thunk.bx>
c00301c1:	81 c3 3f be 00 00    	add    $0xbe3f,%ebx
c00301c7:	8b 45 08             	mov    0x8(%ebp),%eax
c00301ca:	83 e0 7f             	and    $0x7f,%eax
c00301cd:	89 c2                	mov    %eax,%edx
c00301cf:	89 d0                	mov    %edx,%eax
c00301d1:	c1 e0 06             	shl    $0x6,%eax
c00301d4:	01 d0                	add    %edx,%eax
c00301d6:	c1 e0 03             	shl    $0x3,%eax
c00301d9:	8d 93 00 10 00 00    	lea    0x1000(%ebx),%edx
c00301df:	01 d0                	add    %edx,%eax
c00301e1:	89 45 f4             	mov    %eax,-0xc(%ebp)
c00301e4:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00301e7:	8a 40 04             	mov    0x4(%eax),%al
c00301ea:	3c 01                	cmp    $0x1,%al
c00301ec:	75 0a                	jne    c00301f8 <cache_fetch+0x43>
c00301ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00301f1:	8b 00                	mov    (%eax),%eax
c00301f3:	3b 45 08             	cmp    0x8(%ebp),%eax
c00301f6:	74 57                	je     c003024f <cache_fetch+0x9a>
c00301f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00301fb:	8a 40 04             	mov    0x4(%eax),%al
c00301fe:	3c 01                	cmp    $0x1,%al
c0030200:	75 22                	jne    c0030224 <cache_fetch+0x6f>
c0030202:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030205:	8a 40 05             	mov    0x5(%eax),%al
c0030208:	3c 01                	cmp    $0x1,%al
c003020a:	75 18                	jne    c0030224 <cache_fetch+0x6f>
c003020c:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003020f:	8b 00                	mov    (%eax),%eax
c0030211:	8b 55 f4             	mov    -0xc(%ebp),%edx
c0030214:	83 c2 06             	add    $0x6,%edx
c0030217:	83 ec 08             	sub    $0x8,%esp
c003021a:	50                   	push   %eax
c003021b:	52                   	push   %edx
c003021c:	e8 c2 02 00 00       	call   c00304e3 <disk_do_write>
c0030221:	83 c4 10             	add    $0x10,%esp
c0030224:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030227:	83 c0 06             	add    $0x6,%eax
c003022a:	83 ec 08             	sub    $0x8,%esp
c003022d:	ff 75 08             	pushl  0x8(%ebp)
c0030230:	50                   	push   %eax
c0030231:	e8 42 02 00 00       	call   c0030478 <disk_do_read>
c0030236:	83 c4 10             	add    $0x10,%esp
c0030239:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003023c:	c6 40 04 01          	movb   $0x1,0x4(%eax)
c0030240:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030243:	8b 55 08             	mov    0x8(%ebp),%edx
c0030246:	89 10                	mov    %edx,(%eax)
c0030248:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003024b:	c6 40 05 00          	movb   $0x0,0x5(%eax)
c003024f:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030252:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0030255:	c9                   	leave  
c0030256:	c3                   	ret    

c0030257 <read_byte>:
c0030257:	55                   	push   %ebp
c0030258:	89 e5                	mov    %esp,%ebp
c003025a:	83 ec 18             	sub    $0x18,%esp
c003025d:	e8 80 00 00 00       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030262:	05 9e bd 00 00       	add    $0xbd9e,%eax
c0030267:	8b 45 08             	mov    0x8(%ebp),%eax
c003026a:	c1 e8 09             	shr    $0x9,%eax
c003026d:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0030270:	83 ec 0c             	sub    $0xc,%esp
c0030273:	ff 75 f4             	pushl  -0xc(%ebp)
c0030276:	e8 3a ff ff ff       	call   c00301b5 <cache_fetch>
c003027b:	83 c4 10             	add    $0x10,%esp
c003027e:	89 45 f0             	mov    %eax,-0x10(%ebp)
c0030281:	8b 45 08             	mov    0x8(%ebp),%eax
c0030284:	25 ff 01 00 00       	and    $0x1ff,%eax
c0030289:	89 c2                	mov    %eax,%edx
c003028b:	8b 45 f0             	mov    -0x10(%ebp),%eax
c003028e:	8a 44 10 06          	mov    0x6(%eax,%edx,1),%al
c0030292:	c9                   	leave  
c0030293:	c3                   	ret    

c0030294 <write_byte>:
c0030294:	55                   	push   %ebp
c0030295:	89 e5                	mov    %esp,%ebp
c0030297:	83 ec 28             	sub    $0x28,%esp
c003029a:	e8 43 00 00 00       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003029f:	05 61 bd 00 00       	add    $0xbd61,%eax
c00302a4:	8b 45 0c             	mov    0xc(%ebp),%eax
c00302a7:	88 45 e4             	mov    %al,-0x1c(%ebp)
c00302aa:	8b 45 08             	mov    0x8(%ebp),%eax
c00302ad:	c1 e8 09             	shr    $0x9,%eax
c00302b0:	89 45 f4             	mov    %eax,-0xc(%ebp)
c00302b3:	83 ec 0c             	sub    $0xc,%esp
c00302b6:	ff 75 f4             	pushl  -0xc(%ebp)
c00302b9:	e8 f7 fe ff ff       	call   c00301b5 <cache_fetch>
c00302be:	83 c4 10             	add    $0x10,%esp
c00302c1:	89 45 f0             	mov    %eax,-0x10(%ebp)
c00302c4:	8b 45 08             	mov    0x8(%ebp),%eax
c00302c7:	25 ff 01 00 00       	and    $0x1ff,%eax
c00302cc:	89 c1                	mov    %eax,%ecx
c00302ce:	8b 45 f0             	mov    -0x10(%ebp),%eax
c00302d1:	8a 55 e4             	mov    -0x1c(%ebp),%dl
c00302d4:	88 54 08 06          	mov    %dl,0x6(%eax,%ecx,1)
c00302d8:	8b 45 f0             	mov    -0x10(%ebp),%eax
c00302db:	c6 40 05 01          	movb   $0x1,0x5(%eax)
c00302df:	90                   	nop
c00302e0:	c9                   	leave  
c00302e1:	c3                   	ret    

c00302e2 <__x86.get_pc_thunk.ax>:
c00302e2:	8b 04 24             	mov    (%esp),%eax
c00302e5:	c3                   	ret    

c00302e6 <__x86.get_pc_thunk.dx>:
c00302e6:	8b 14 24             	mov    (%esp),%edx
c00302e9:	c3                   	ret    

c00302ea <__x86.get_pc_thunk.bx>:
c00302ea:	8b 1c 24             	mov    (%esp),%ebx
c00302ed:	c3                   	ret    

c00302ee <in_byte>:
c00302ee:	55                   	push   %ebp
c00302ef:	89 e5                	mov    %esp,%ebp
c00302f1:	83 ec 14             	sub    $0x14,%esp
c00302f4:	e8 e9 ff ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00302f9:	05 07 bd 00 00       	add    $0xbd07,%eax
c00302fe:	8b 45 08             	mov    0x8(%ebp),%eax
c0030301:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
c0030305:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0030308:	89 c2                	mov    %eax,%edx
c003030a:	ec                   	in     (%dx),%al
c003030b:	88 45 ff             	mov    %al,-0x1(%ebp)
c003030e:	8a 45 ff             	mov    -0x1(%ebp),%al
c0030311:	c9                   	leave  
c0030312:	c3                   	ret    

c0030313 <in_long>:
c0030313:	55                   	push   %ebp
c0030314:	89 e5                	mov    %esp,%ebp
c0030316:	83 ec 14             	sub    $0x14,%esp
c0030319:	e8 c4 ff ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003031e:	05 e2 bc 00 00       	add    $0xbce2,%eax
c0030323:	8b 45 08             	mov    0x8(%ebp),%eax
c0030326:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
c003032a:	8b 45 ec             	mov    -0x14(%ebp),%eax
c003032d:	89 c2                	mov    %eax,%edx
c003032f:	ed                   	in     (%dx),%eax
c0030330:	89 45 fc             	mov    %eax,-0x4(%ebp)
c0030333:	8b 45 fc             	mov    -0x4(%ebp),%eax
c0030336:	c9                   	leave  
c0030337:	c3                   	ret    

c0030338 <out_byte>:
c0030338:	55                   	push   %ebp
c0030339:	89 e5                	mov    %esp,%ebp
c003033b:	83 ec 08             	sub    $0x8,%esp
c003033e:	e8 9f ff ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030343:	05 bd bc 00 00       	add    $0xbcbd,%eax
c0030348:	8b 45 08             	mov    0x8(%ebp),%eax
c003034b:	8b 55 0c             	mov    0xc(%ebp),%edx
c003034e:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
c0030352:	88 55 f8             	mov    %dl,-0x8(%ebp)
c0030355:	8a 45 f8             	mov    -0x8(%ebp),%al
c0030358:	8b 55 fc             	mov    -0x4(%ebp),%edx
c003035b:	ee                   	out    %al,(%dx)
c003035c:	90                   	nop
c003035d:	c9                   	leave  
c003035e:	c3                   	ret    
...
c0030362:	83 ec 04             	sub    $0x4,%esp
c0030365:	e8 78 ff ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003036a:	05 96 bc 00 00       	add    $0xbc96,%eax
c003036f:	8b 45 08             	mov    0x8(%ebp),%eax
c0030372:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
c0030376:	8b 45 0c             	mov    0xc(%ebp),%eax
c0030379:	8b 55 fc             	mov    -0x4(%ebp),%edx
c003037c:	ef                   	out    %eax,(%dx)
c003037d:	90                   	nop
c003037e:	c9                   	leave  
c003037f:	c3                   	ret    

c0030380 <waitdisk>:
c0030380:	55                   	push   %ebp
c0030381:	89 e5                	mov    %esp,%ebp
c0030383:	e8 5a ff ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030388:	05 78 bc 00 00       	add    $0xbc78,%eax
c003038d:	90                   	nop
c003038e:	68 f7 01 00 00       	push   $0x1f7
c0030393:	e8 56 ff ff ff       	call   c00302ee <in_byte>
c0030398:	83 c4 04             	add    $0x4,%esp
c003039b:	0f b6 c0             	movzbl %al,%eax
c003039e:	25 c0 00 00 00       	and    $0xc0,%eax
c00303a3:	83 f8 40             	cmp    $0x40,%eax
c00303a6:	75 e6                	jne    c003038e <waitdisk+0xe>
c00303a8:	90                   	nop
c00303a9:	c9                   	leave  
c00303aa:	c3                   	ret    

c00303ab <ide_prepare>:
c00303ab:	55                   	push   %ebp
c00303ac:	89 e5                	mov    %esp,%ebp
c00303ae:	e8 2f ff ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00303b3:	05 4d bc 00 00       	add    $0xbc4d,%eax
c00303b8:	e8 c3 ff ff ff       	call   c0030380 <waitdisk>
c00303bd:	6a 00                	push   $0x0
c00303bf:	68 f1 01 00 00       	push   $0x1f1
c00303c4:	e8 6f ff ff ff       	call   c0030338 <out_byte>
c00303c9:	83 c4 08             	add    $0x8,%esp
c00303cc:	6a 01                	push   $0x1
c00303ce:	68 f2 01 00 00       	push   $0x1f2
c00303d3:	e8 60 ff ff ff       	call   c0030338 <out_byte>
c00303d8:	83 c4 08             	add    $0x8,%esp
c00303db:	8b 45 08             	mov    0x8(%ebp),%eax
c00303de:	0f b6 c0             	movzbl %al,%eax
c00303e1:	50                   	push   %eax
c00303e2:	68 f3 01 00 00       	push   $0x1f3
c00303e7:	e8 4c ff ff ff       	call   c0030338 <out_byte>
c00303ec:	83 c4 08             	add    $0x8,%esp
c00303ef:	8b 45 08             	mov    0x8(%ebp),%eax
c00303f2:	c1 e8 08             	shr    $0x8,%eax
c00303f5:	0f b6 c0             	movzbl %al,%eax
c00303f8:	50                   	push   %eax
c00303f9:	68 f4 01 00 00       	push   $0x1f4
c00303fe:	e8 35 ff ff ff       	call   c0030338 <out_byte>
c0030403:	83 c4 08             	add    $0x8,%esp
c0030406:	8b 45 08             	mov    0x8(%ebp),%eax
c0030409:	c1 e8 10             	shr    $0x10,%eax
c003040c:	0f b6 c0             	movzbl %al,%eax
c003040f:	50                   	push   %eax
c0030410:	68 f5 01 00 00       	push   $0x1f5
c0030415:	e8 1e ff ff ff       	call   c0030338 <out_byte>
c003041a:	83 c4 08             	add    $0x8,%esp
c003041d:	8b 45 08             	mov    0x8(%ebp),%eax
c0030420:	c1 e8 18             	shr    $0x18,%eax
c0030423:	83 c8 e0             	or     $0xffffffe0,%eax
c0030426:	0f b6 c0             	movzbl %al,%eax
c0030429:	50                   	push   %eax
c003042a:	68 f6 01 00 00       	push   $0x1f6
c003042f:	e8 04 ff ff ff       	call   c0030338 <out_byte>
c0030434:	83 c4 08             	add    $0x8,%esp
c0030437:	90                   	nop
c0030438:	c9                   	leave  
c0030439:	c3                   	ret    
...
c003043d:	e8 a0 fe ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030442:	05 be bb 00 00       	add    $0xbbbe,%eax
c0030447:	6a 20                	push   $0x20
c0030449:	68 f7 01 00 00       	push   $0x1f7
c003044e:	e8 e5 fe ff ff       	call   c0030338 <out_byte>
c0030453:	83 c4 08             	add    $0x8,%esp
c0030456:	90                   	nop
c0030457:	c9                   	leave  
c0030458:	c3                   	ret    

c0030459 <issue_write>:
c0030459:	55                   	push   %ebp
c003045a:	89 e5                	mov    %esp,%ebp
c003045c:	e8 81 fe ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030461:	05 9f bb 00 00       	add    $0xbb9f,%eax
c0030466:	6a 30                	push   $0x30
c0030468:	68 f7 01 00 00       	push   $0x1f7
c003046d:	e8 c6 fe ff ff       	call   c0030338 <out_byte>
c0030472:	83 c4 08             	add    $0x8,%esp
c0030475:	90                   	nop
c0030476:	c9                   	leave  
c0030477:	c3                   	ret    

c0030478 <disk_do_read>:
c0030478:	55                   	push   %ebp
c0030479:	89 e5                	mov    %esp,%ebp
c003047b:	53                   	push   %ebx
c003047c:	83 ec 14             	sub    $0x14,%esp
c003047f:	e8 66 fe ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0030484:	81 c3 7c bb 00 00    	add    $0xbb7c,%ebx
c003048a:	e8 c6 02 00 00       	call   c0030755 <clear_ide_intr>
c003048f:	83 ec 0c             	sub    $0xc,%esp
c0030492:	ff 75 0c             	pushl  0xc(%ebp)
c0030495:	e8 11 ff ff ff       	call   c00303ab <ide_prepare>
c003049a:	83 c4 10             	add    $0x10,%esp
c003049d:	e8 98 ff ff ff       	call   c003043a <issue_read>
c00304a2:	e8 c8 02 00 00       	call   c003076f <wait_ide_intr>
c00304a7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c00304ae:	eb 25                	jmp    c00304d5 <disk_do_read+0x5d>
c00304b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00304b3:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
c00304ba:	8b 45 08             	mov    0x8(%ebp),%eax
c00304bd:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
c00304c0:	83 ec 0c             	sub    $0xc,%esp
c00304c3:	68 f0 01 00 00       	push   $0x1f0
c00304c8:	e8 46 fe ff ff       	call   c0030313 <in_long>
c00304cd:	83 c4 10             	add    $0x10,%esp
c00304d0:	89 03                	mov    %eax,(%ebx)
c00304d2:	ff 45 f4             	incl   -0xc(%ebp)
c00304d5:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00304d8:	83 f8 7f             	cmp    $0x7f,%eax
c00304db:	76 d3                	jbe    c00304b0 <disk_do_read+0x38>
c00304dd:	90                   	nop
c00304de:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00304e1:	c9                   	leave  
c00304e2:	c3                   	ret    

c00304e3 <disk_do_write>:
c00304e3:	55                   	push   %ebp
c00304e4:	89 e5                	mov    %esp,%ebp
c00304e6:	83 ec 10             	sub    $0x10,%esp
c00304e9:	e8 f4 fd ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00304ee:	05 12 bb 00 00       	add    $0xbb12,%eax
c00304f3:	ff 75 0c             	pushl  0xc(%ebp)
c00304f6:	e8 b0 fe ff ff       	call   c00303ab <ide_prepare>
c00304fb:	83 c4 04             	add    $0x4,%esp
c00304fe:	e8 56 ff ff ff       	call   c0030459 <issue_write>
c0030503:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
c003050a:	eb 22                	jmp    c003052e <disk_do_write+0x4b>
c003050c:	8b 45 fc             	mov    -0x4(%ebp),%eax
c003050f:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
c0030516:	8b 45 08             	mov    0x8(%ebp),%eax
c0030519:	01 d0                	add    %edx,%eax
c003051b:	8b 00                	mov    (%eax),%eax
c003051d:	50                   	push   %eax
c003051e:	68 f0 01 00 00       	push   $0x1f0
c0030523:	e8 37 fe ff ff       	call   c003035f <out_long>
c0030528:	83 c4 08             	add    $0x8,%esp
c003052b:	ff 45 fc             	incl   -0x4(%ebp)
c003052e:	8b 45 fc             	mov    -0x4(%ebp),%eax
c0030531:	83 f8 7f             	cmp    $0x7f,%eax
c0030534:	76 d6                	jbe    c003050c <disk_do_write+0x29>
c0030536:	90                   	nop
c0030537:	c9                   	leave  
c0030538:	c3                   	ret    

c0030539 <in_byte>:
c0030539:	55                   	push   %ebp
c003053a:	89 e5                	mov    %esp,%ebp
c003053c:	83 ec 14             	sub    $0x14,%esp
c003053f:	e8 9e fd ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030544:	05 bc ba 00 00       	add    $0xbabc,%eax
c0030549:	8b 45 08             	mov    0x8(%ebp),%eax
c003054c:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
c0030550:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0030553:	89 c2                	mov    %eax,%edx
c0030555:	ec                   	in     (%dx),%al
c0030556:	88 45 ff             	mov    %al,-0x1(%ebp)
c0030559:	8a 45 ff             	mov    -0x1(%ebp),%al
c003055c:	c9                   	leave  
c003055d:	c3                   	ret    

c003055e <out_byte>:
c003055e:	55                   	push   %ebp
c003055f:	89 e5                	mov    %esp,%ebp
c0030561:	83 ec 08             	sub    $0x8,%esp
c0030564:	e8 79 fd ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030569:	05 97 ba 00 00       	add    $0xba97,%eax
c003056e:	8b 45 08             	mov    0x8(%ebp),%eax
c0030571:	8b 55 0c             	mov    0xc(%ebp),%edx
c0030574:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
c0030578:	88 55 f8             	mov    %dl,-0x8(%ebp)
c003057b:	8a 45 f8             	mov    -0x8(%ebp),%al
c003057e:	8b 55 fc             	mov    -0x4(%ebp),%edx
c0030581:	ee                   	out    %al,(%dx)
c0030582:	90                   	nop
c0030583:	c9                   	leave  
c0030584:	c3                   	ret    
...
c0030588:	83 ec 04             	sub    $0x4,%esp
c003058b:	e8 52 fd ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030590:	05 70 ba 00 00       	add    $0xba70,%eax
c0030595:	8b 45 08             	mov    0x8(%ebp),%eax
c0030598:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
c003059c:	8b 45 0c             	mov    0xc(%ebp),%eax
c003059f:	8b 55 fc             	mov    -0x4(%ebp),%edx
c00305a2:	ef                   	out    %eax,(%dx)
c00305a3:	90                   	nop
c00305a4:	c9                   	leave  
c00305a5:	c3                   	ret    

c00305a6 <dma_prepare>:
c00305a6:	55                   	push   %ebp
c00305a7:	89 e5                	mov    %esp,%ebp
c00305a9:	83 ec 10             	sub    $0x10,%esp
c00305ac:	e8 31 fd ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00305b1:	05 4f ba 00 00       	add    $0xba4f,%eax
c00305b6:	8b 55 08             	mov    0x8(%ebp),%edx
c00305b9:	81 c2 00 00 00 40    	add    $0x40000000,%edx
c00305bf:	89 55 fc             	mov    %edx,-0x4(%ebp)
c00305c2:	c7 c2 54 f0 06 c0    	mov    $0xc006f054,%edx
c00305c8:	8b 4d fc             	mov    -0x4(%ebp),%ecx
c00305cb:	89 0a                	mov    %ecx,(%edx)
c00305cd:	c7 c2 54 f0 06 c0    	mov    $0xc006f054,%edx
c00305d3:	66 c7 42 04 00 02    	movw   $0x200,0x4(%edx)
c00305d9:	c7 c2 54 f0 06 c0    	mov    $0xc006f054,%edx
c00305df:	8a 4a 07             	mov    0x7(%edx),%cl
c00305e2:	83 c9 80             	or     $0xffffff80,%ecx
c00305e5:	88 4a 07             	mov    %cl,0x7(%edx)
c00305e8:	c7 c1 54 f0 06 c0    	mov    $0xc006f054,%ecx
c00305ee:	66 8b 51 06          	mov    0x6(%ecx),%dx
c00305f2:	81 e2 00 80 ff ff    	and    $0xffff8000,%edx
c00305f8:	66 89 51 06          	mov    %dx,0x6(%ecx)
c00305fc:	c7 c0 54 f0 06 c0    	mov    $0xc006f054,%eax
c0030602:	05 00 00 00 40       	add    $0x40000000,%eax
c0030607:	89 45 f8             	mov    %eax,-0x8(%ebp)
c003060a:	ff 75 f8             	pushl  -0x8(%ebp)
c003060d:	68 44 c0 00 00       	push   $0xc044
c0030612:	e8 6e ff ff ff       	call   c0030585 <out_long>
c0030617:	83 c4 08             	add    $0x8,%esp
c003061a:	90                   	nop
c003061b:	c9                   	leave  
c003061c:	c3                   	ret    

c003061d <dma_issue_read>:
c003061d:	55                   	push   %ebp
c003061e:	89 e5                	mov    %esp,%ebp
c0030620:	e8 bd fc ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030625:	05 db b9 00 00       	add    $0xb9db,%eax
c003062a:	68 40 c0 00 00       	push   $0xc040
c003062f:	e8 05 ff ff ff       	call   c0030539 <in_byte>
c0030634:	83 c4 04             	add    $0x4,%esp
c0030637:	83 c8 09             	or     $0x9,%eax
c003063a:	0f b6 c0             	movzbl %al,%eax
c003063d:	50                   	push   %eax
c003063e:	68 40 c0 00 00       	push   $0xc040
c0030643:	e8 16 ff ff ff       	call   c003055e <out_byte>
c0030648:	83 c4 08             	add    $0x8,%esp
c003064b:	90                   	nop
c003064c:	c9                   	leave  
c003064d:	c3                   	ret    

c003064e <wait_intr>:
c003064e:	55                   	push   %ebp
c003064f:	89 e5                	mov    %esp,%ebp
c0030651:	e8 8c fc ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030656:	05 aa b9 00 00       	add    $0xb9aa,%eax
c003065b:	f4                   	hlt    
c003065c:	90                   	nop
c003065d:	5d                   	pop    %ebp
c003065e:	c3                   	ret    
...
c003065f <ide_read>:
c003065f:	55                   	push   %ebp
c0030660:	89 e5                	mov    %esp,%ebp
c0030662:	56                   	push   %esi
c0030663:	53                   	push   %ebx
c0030664:	83 ec 10             	sub    $0x10,%esp
c0030667:	e8 7e fc ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c003066c:	81 c3 94 b9 00 00    	add    $0xb994,%ebx
c0030672:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c0030679:	eb 22                	jmp    c003069d <ide_read+0x3e>
c003067b:	8b 55 08             	mov    0x8(%ebp),%edx
c003067e:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030681:	8d 34 02             	lea    (%edx,%eax,1),%esi
c0030684:	8b 55 0c             	mov    0xc(%ebp),%edx
c0030687:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003068a:	01 d0                	add    %edx,%eax
c003068c:	83 ec 0c             	sub    $0xc,%esp
c003068f:	50                   	push   %eax
c0030690:	e8 c2 fb ff ff       	call   c0030257 <read_byte>
c0030695:	83 c4 10             	add    $0x10,%esp
c0030698:	88 06                	mov    %al,(%esi)
c003069a:	ff 45 f4             	incl   -0xc(%ebp)
c003069d:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00306a0:	3b 45 10             	cmp    0x10(%ebp),%eax
c00306a3:	72 d6                	jb     c003067b <ide_read+0x1c>
c00306a5:	90                   	nop
c00306a6:	8d 65 f8             	lea    -0x8(%ebp),%esp
c00306a9:	5b                   	pop    %ebx
c00306aa:	5e                   	pop    %esi
c00306ab:	5d                   	pop    %ebp
c00306ac:	c3                   	ret    
...
c00306ad <ide_write>:
c00306ad:	55                   	push   %ebp
c00306ae:	89 e5                	mov    %esp,%ebp
c00306b0:	53                   	push   %ebx
c00306b1:	83 ec 14             	sub    $0x14,%esp
c00306b4:	e8 31 fc ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c00306b9:	81 c3 47 b9 00 00    	add    $0xb947,%ebx
c00306bf:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c00306c6:	eb 25                	jmp    c00306ed <ide_write+0x40>
c00306c8:	8b 55 08             	mov    0x8(%ebp),%edx
c00306cb:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00306ce:	01 d0                	add    %edx,%eax
c00306d0:	8a 00                	mov    (%eax),%al
c00306d2:	0f b6 c0             	movzbl %al,%eax
c00306d5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
c00306d8:	8b 55 f4             	mov    -0xc(%ebp),%edx
c00306db:	01 ca                	add    %ecx,%edx
c00306dd:	83 ec 08             	sub    $0x8,%esp
c00306e0:	50                   	push   %eax
c00306e1:	52                   	push   %edx
c00306e2:	e8 ad fb ff ff       	call   c0030294 <write_byte>
c00306e7:	83 c4 10             	add    $0x10,%esp
c00306ea:	ff 45 f4             	incl   -0xc(%ebp)
c00306ed:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00306f0:	3b 45 10             	cmp    0x10(%ebp),%eax
c00306f3:	72 d3                	jb     c00306c8 <ide_write+0x1b>
c00306f5:	90                   	nop
c00306f6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00306f9:	c9                   	leave  
c00306fa:	c3                   	ret    

c00306fb <ide_writeback>:
c00306fb:	55                   	push   %ebp
c00306fc:	89 e5                	mov    %esp,%ebp
c00306fe:	53                   	push   %ebx
c00306ff:	83 ec 04             	sub    $0x4,%esp
c0030702:	e8 e3 fb ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0030707:	81 c3 f9 b8 00 00    	add    $0xb8f9,%ebx
c003070d:	8b 83 04 14 01 00    	mov    0x11404(%ebx),%eax
c0030713:	40                   	inc    %eax
c0030714:	89 83 04 14 01 00    	mov    %eax,0x11404(%ebx)
c003071a:	8b 83 04 14 01 00    	mov    0x11404(%ebx),%eax
c0030720:	83 f8 64             	cmp    $0x64,%eax
c0030723:	75 0f                	jne    c0030734 <ide_writeback+0x39>
c0030725:	e8 f2 f9 ff ff       	call   c003011c <cache_writeback>
c003072a:	c7 83 04 14 01 00 00 	movl   $0x0,0x11404(%ebx)
c0030731:	00 00 00 
c0030734:	90                   	nop
c0030735:	83 c4 04             	add    $0x4,%esp
c0030738:	5b                   	pop    %ebx
c0030739:	5d                   	pop    %ebp
c003073a:	c3                   	ret    

c003073b <ide_intr>:
c003073b:	55                   	push   %ebp
c003073c:	89 e5                	mov    %esp,%ebp
c003073e:	e8 9f fb ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030743:	05 bd b8 00 00       	add    $0xb8bd,%eax
c0030748:	c7 80 00 14 01 00 01 	movl   $0x1,0x11400(%eax)
c003074f:	00 00 00 
c0030752:	90                   	nop
c0030753:	5d                   	pop    %ebp
c0030754:	c3                   	ret    

c0030755 <clear_ide_intr>:
c0030755:	55                   	push   %ebp
c0030756:	89 e5                	mov    %esp,%ebp
c0030758:	e8 85 fb ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003075d:	05 a3 b8 00 00       	add    $0xb8a3,%eax
c0030762:	c7 80 00 14 01 00 00 	movl   $0x0,0x11400(%eax)
c0030769:	00 00 00 
c003076c:	90                   	nop
c003076d:	5d                   	pop    %ebp
c003076e:	c3                   	ret    

c003076f <wait_ide_intr>:
c003076f:	55                   	push   %ebp
c0030770:	89 e5                	mov    %esp,%ebp
c0030772:	53                   	push   %ebx
c0030773:	e8 72 fb ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0030778:	81 c3 88 b8 00 00    	add    $0xb888,%ebx
c003077e:	eb 05                	jmp    c0030785 <wait_ide_intr+0x16>
c0030780:	e8 c9 fe ff ff       	call   c003064e <wait_intr>
c0030785:	8b 83 00 14 01 00    	mov    0x11400(%ebx),%eax
c003078b:	85 c0                	test   %eax,%eax
c003078d:	74 f1                	je     c0030780 <wait_ide_intr+0x11>
c003078f:	e8 c1 ff ff ff       	call   c0030755 <clear_ide_intr>
c0030794:	90                   	nop
c0030795:	5b                   	pop    %ebx
c0030796:	5d                   	pop    %ebp
c0030797:	c3                   	ret    
...
c0030798 <init_ide>:
c0030798:	55                   	push   %ebp
c0030799:	89 e5                	mov    %esp,%ebp
c003079b:	53                   	push   %ebx
c003079c:	83 ec 04             	sub    $0x4,%esp
c003079f:	e8 46 fb ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c00307a4:	81 c3 5c b8 00 00    	add    $0xb85c,%ebx
c00307aa:	e8 2a f9 ff ff       	call   c00300d9 <cache_init>
c00307af:	83 ec 08             	sub    $0x8,%esp
c00307b2:	8d 83 fb 46 ff ff    	lea    -0xb905(%ebx),%eax
c00307b8:	50                   	push   %eax
c00307b9:	6a 00                	push   $0x0
c00307bb:	e8 d4 07 00 00       	call   c0030f94 <add_irq_handle>
c00307c0:	83 c4 10             	add    $0x10,%esp
c00307c3:	83 ec 08             	sub    $0x8,%esp
c00307c6:	8d 83 3b 47 ff ff    	lea    -0xb8c5(%ebx),%eax
c00307cc:	50                   	push   %eax
c00307cd:	6a 0e                	push   $0xe
c00307cf:	e8 c0 07 00 00       	call   c0030f94 <add_irq_handle>
c00307d4:	83 c4 10             	add    $0x10,%esp
c00307d7:	90                   	nop
c00307d8:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00307db:	c9                   	leave  
c00307dc:	c3                   	ret    
...
c00307e0:	e8 fd fa ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00307e5:	05 1b b8 00 00       	add    $0xb81b,%eax
c00307ea:	8b 45 08             	mov    0x8(%ebp),%eax
c00307ed:	0f 22 d8             	mov    %eax,%cr3
c00307f0:	90                   	nop
c00307f1:	5d                   	pop    %ebp
c00307f2:	c3                   	ret    

c00307f3 <loader>:
c00307f3:	55                   	push   %ebp
c00307f4:	89 e5                	mov    %esp,%ebp
c00307f6:	53                   	push   %ebx
c00307f7:	83 ec 24             	sub    $0x24,%esp
c00307fa:	e8 eb fa ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c00307ff:	81 c3 01 b8 00 00    	add    $0xb801,%ebx
c0030805:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
c003080c:	8d 83 cc c6 ff ff    	lea    -0x3934(%ebx),%eax
c0030812:	50                   	push   %eax
c0030813:	6a 1b                	push   $0x1b
c0030815:	8d 83 80 c6 ff ff    	lea    -0x3980(%ebx),%eax
c003081b:	50                   	push   %eax
c003081c:	8d 83 90 c6 ff ff    	lea    -0x3970(%ebx),%eax
c0030822:	50                   	push   %eax
c0030823:	e8 cf 09 00 00       	call   c00311f7 <printk>
c0030828:	83 c4 10             	add    $0x10,%esp
c003082b:	8b 45 f0             	mov    -0x10(%ebp),%eax
c003082e:	8b 50 1c             	mov    0x1c(%eax),%edx
c0030831:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0030834:	01 d0                	add    %edx,%eax
c0030836:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0030839:	8b 45 f0             	mov    -0x10(%ebp),%eax
c003083c:	8b 40 2c             	mov    0x2c(%eax),%eax
c003083f:	0f b7 c0             	movzwl %ax,%eax
c0030842:	c1 e0 05             	shl    $0x5,%eax
c0030845:	89 c2                	mov    %eax,%edx
c0030847:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003084a:	01 d0                	add    %edx,%eax
c003084c:	89 45 ec             	mov    %eax,-0x14(%ebp)
c003084f:	e9 a4 00 00 00       	jmp    c00308f8 <loader+0x105>
c0030854:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030857:	8b 00                	mov    (%eax),%eax
c0030859:	83 f8 01             	cmp    $0x1,%eax
c003085c:	0f 85 92 00 00 00    	jne    c00308f4 <loader+0x101>
c0030862:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030865:	8b 50 08             	mov    0x8(%eax),%edx
c0030868:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003086b:	8b 40 14             	mov    0x14(%eax),%eax
c003086e:	01 d0                	add    %edx,%eax
c0030870:	48                   	dec    %eax
c0030871:	89 45 e8             	mov    %eax,-0x18(%ebp)
c0030874:	c7 c0 a8 de 04 c0    	mov    $0xc004dea8,%eax
c003087a:	8b 00                	mov    (%eax),%eax
c003087c:	3b 45 e8             	cmp    -0x18(%ebp),%eax
c003087f:	73 0b                	jae    c003088c <loader+0x99>
c0030881:	c7 c0 a8 de 04 c0    	mov    $0xc004dea8,%eax
c0030887:	8b 55 e8             	mov    -0x18(%ebp),%edx
c003088a:	89 10                	mov    %edx,(%eax)
c003088c:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003088f:	8b 40 14             	mov    0x14(%eax),%eax
c0030892:	89 c2                	mov    %eax,%edx
c0030894:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0030897:	8b 40 08             	mov    0x8(%eax),%eax
c003089a:	83 ec 08             	sub    $0x8,%esp
c003089d:	52                   	push   %edx
c003089e:	50                   	push   %eax
c003089f:	e8 7c 12 00 00       	call   c0031b20 <mm_malloc>
c00308a4:	83 c4 10             	add    $0x10,%esp
c00308a7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
c00308aa:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00308ad:	8b 50 10             	mov    0x10(%eax),%edx
c00308b0:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00308b3:	8b 48 04             	mov    0x4(%eax),%ecx
c00308b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
c00308b9:	01 c1                	add    %eax,%ecx
c00308bb:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c00308be:	83 ec 04             	sub    $0x4,%esp
c00308c1:	52                   	push   %edx
c00308c2:	51                   	push   %ecx
c00308c3:	50                   	push   %eax
c00308c4:	e8 eb 14 00 00       	call   c0031db4 <memcpy>
c00308c9:	83 c4 10             	add    $0x10,%esp
c00308cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00308cf:	8b 50 14             	mov    0x14(%eax),%edx
c00308d2:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00308d5:	8b 40 10             	mov    0x10(%eax),%eax
c00308d8:	29 c2                	sub    %eax,%edx
c00308da:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00308dd:	8b 48 10             	mov    0x10(%eax),%ecx
c00308e0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c00308e3:	01 c8                	add    %ecx,%eax
c00308e5:	83 ec 04             	sub    $0x4,%esp
c00308e8:	52                   	push   %edx
c00308e9:	6a 00                	push   $0x0
c00308eb:	50                   	push   %eax
c00308ec:	e8 0b 15 00 00       	call   c0031dfc <memset>
c00308f1:	83 c4 10             	add    $0x10,%esp
c00308f4:	83 45 f4 20          	addl   $0x20,-0xc(%ebp)
c00308f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00308fb:	3b 45 ec             	cmp    -0x14(%ebp),%eax
c00308fe:	0f 82 50 ff ff ff    	jb     c0030854 <loader+0x61>
c0030904:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0030907:	8b 40 18             	mov    0x18(%eax),%eax
c003090a:	89 45 e0             	mov    %eax,-0x20(%ebp)
c003090d:	83 ec 08             	sub    $0x8,%esp
c0030910:	68 00 00 10 00       	push   $0x100000
c0030915:	68 00 00 f0 bf       	push   $0xbff00000
c003091a:	e8 01 12 00 00       	call   c0031b20 <mm_malloc>
c003091f:	83 c4 10             	add    $0x10,%esp
c0030922:	e8 6f 0d 00 00       	call   c0031696 <get_ucr3>
c0030927:	83 ec 0c             	sub    $0xc,%esp
c003092a:	50                   	push   %eax
c003092b:	e8 ad fe ff ff       	call   c00307dd <write_cr3>
c0030930:	83 c4 10             	add    $0x10,%esp
c0030933:	8b 45 e0             	mov    -0x20(%ebp),%eax
c0030936:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0030939:	c9                   	leave  
c003093a:	c3                   	ret    
...
c003093e:	53                   	push   %ebx
c003093f:	83 ec 04             	sub    $0x4,%esp
c0030942:	e8 9b f9 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030947:	05 b9 b6 00 00       	add    $0xb6b9,%eax
c003094c:	8d 90 60 c9 ff ff    	lea    -0x36a0(%eax),%edx
c0030952:	52                   	push   %edx
c0030953:	6a 2c                	push   $0x2c
c0030955:	8d 90 97 c7 ff ff    	lea    -0x3869(%eax),%edx
c003095b:	52                   	push   %edx
c003095c:	8d 90 a4 c7 ff ff    	lea    -0x385c(%eax),%edx
c0030962:	52                   	push   %edx
c0030963:	89 c3                	mov    %eax,%ebx
c0030965:	e8 8d 08 00 00       	call   c00311f7 <printk>
c003096a:	83 c4 10             	add    $0x10,%esp
c003096d:	b8 01 00 00 00       	mov    $0x1,%eax
c0030972:	82 b8 ff ff ff ff 8b 	cmpb   $0x8b,-0x1(%eax)
c0030979:	5d                   	pop    %ebp
c003097a:	fc                   	cld    
c003097b:	c9                   	leave  
c003097c:	c3                   	ret    
...
c003097d <fs_read>:
c003097d:	55                   	push   %ebp
c003097e:	89 e5                	mov    %esp,%ebp
c0030980:	53                   	push   %ebx
c0030981:	83 ec 04             	sub    $0x4,%esp
c0030984:	e8 61 f9 ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0030989:	81 c3 77 b6 00 00    	add    $0xb677,%ebx
c003098f:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
c0030993:	7f 2f                	jg     c00309c4 <fs_read+0x47>
c0030995:	83 ec 0c             	sub    $0xc,%esp
c0030998:	8d 83 fa c7 ff ff    	lea    -0x3806(%ebx),%eax
c003099e:	50                   	push   %eax
c003099f:	8d 83 68 c9 ff ff    	lea    -0x3698(%ebx),%eax
c00309a5:	50                   	push   %eax
c00309a6:	6a 31                	push   $0x31
c00309a8:	8d 83 97 c7 ff ff    	lea    -0x3869(%ebx),%eax
c00309ae:	50                   	push   %eax
c00309af:	8d 83 04 c8 ff ff    	lea    -0x37fc(%ebx),%eax
c00309b5:	50                   	push   %eax
c00309b6:	e8 3c 08 00 00       	call   c00311f7 <printk>
c00309bb:	83 c4 20             	add    $0x20,%esp
c00309be:	b8 01 00 00 00       	mov    $0x1,%eax
c00309c3:	82 8d 83 68 c9 ff ff 	orb    $0xff,-0x36977d(%ebp)
c00309ca:	50                   	push   %eax
c00309cb:	6a 32                	push   $0x32
c00309cd:	8d 83 97 c7 ff ff    	lea    -0x3869(%ebx),%eax
c00309d3:	50                   	push   %eax
c00309d4:	8d 83 50 c8 ff ff    	lea    -0x37b0(%ebx),%eax
c00309da:	50                   	push   %eax
c00309db:	e8 17 08 00 00       	call   c00311f7 <printk>
c00309e0:	83 c4 10             	add    $0x10,%esp
c00309e3:	b8 01 00 00 00       	mov    $0x1,%eax
c00309e8:	82 b8 ff ff ff ff 8b 	cmpb   $0x8b,-0x1(%eax)
c00309ef:	5d                   	pop    %ebp
c00309f0:	fc                   	cld    
c00309f1:	c9                   	leave  
c00309f2:	c3                   	ret    
...
c00309f3 <fs_write>:
c00309f3:	55                   	push   %ebp
c00309f4:	89 e5                	mov    %esp,%ebp
c00309f6:	53                   	push   %ebx
c00309f7:	83 ec 04             	sub    $0x4,%esp
c00309fa:	e8 e3 f8 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00309ff:	05 01 b6 00 00       	add    $0xb601,%eax
c0030a04:	83 7d 08 02          	cmpl   $0x2,0x8(%ebp)
c0030a08:	7e 31                	jle    c0030a3b <fs_write+0x48>
c0030a0a:	83 ec 0c             	sub    $0xc,%esp
c0030a0d:	8d 90 a6 c8 ff ff    	lea    -0x375a(%eax),%edx
c0030a13:	52                   	push   %edx
c0030a14:	8d 90 70 c9 ff ff    	lea    -0x3690(%eax),%edx
c0030a1a:	52                   	push   %edx
c0030a1b:	6a 37                	push   $0x37
c0030a1d:	8d 90 97 c7 ff ff    	lea    -0x3869(%eax),%edx
c0030a23:	52                   	push   %edx
c0030a24:	8d 90 04 c8 ff ff    	lea    -0x37fc(%eax),%edx
c0030a2a:	52                   	push   %edx
c0030a2b:	89 c3                	mov    %eax,%ebx
c0030a2d:	e8 c5 07 00 00       	call   c00311f7 <printk>
c0030a32:	83 c4 20             	add    $0x20,%esp
c0030a35:	b8 01 00 00 00       	mov    $0x1,%eax
c0030a3a:	82 b8 04 00 00 00 8b 	cmpb   $0x8b,0x4(%eax)
c0030a41:	5d                   	pop    %ebp
c0030a42:	08 8b 4d 0c 8b 55    	or     %cl,0x558b0c4d(%ebx)
c0030a48:	10 82 89 45 10 8b    	adc    %al,-0x74efba77(%edx)
c0030a4e:	45                   	inc    %ebp
c0030a4f:	10 8b 5d fc c9 c3    	adc    %cl,-0x3c3603a3(%ebx)

c0030a55 <fs_lseek>:
c0030a55:	55                   	push   %ebp
c0030a56:	89 e5                	mov    %esp,%ebp
c0030a58:	53                   	push   %ebx
c0030a59:	83 ec 04             	sub    $0x4,%esp
c0030a5c:	e8 81 f8 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030a61:	05 9f b5 00 00       	add    $0xb59f,%eax
c0030a66:	8d 90 7c c9 ff ff    	lea    -0x3684(%eax),%edx
c0030a6c:	52                   	push   %edx
c0030a6d:	6a 46                	push   $0x46
c0030a6f:	8d 90 97 c7 ff ff    	lea    -0x3869(%eax),%edx
c0030a75:	52                   	push   %edx
c0030a76:	8d 90 b0 c8 ff ff    	lea    -0x3750(%eax),%edx
c0030a7c:	52                   	push   %edx
c0030a7d:	89 c3                	mov    %eax,%ebx
c0030a7f:	e8 73 07 00 00       	call   c00311f7 <printk>
c0030a84:	83 c4 10             	add    $0x10,%esp
c0030a87:	b8 01 00 00 00       	mov    $0x1,%eax
c0030a8c:	82 b8 ff ff ff ff 8b 	cmpb   $0x8b,-0x1(%eax)
c0030a93:	5d                   	pop    %ebp
c0030a94:	fc                   	cld    
c0030a95:	c9                   	leave  
c0030a96:	c3                   	ret    
...
c0030a97 <fs_close>:
c0030a97:	55                   	push   %ebp
c0030a98:	89 e5                	mov    %esp,%ebp
c0030a9a:	53                   	push   %ebx
c0030a9b:	83 ec 04             	sub    $0x4,%esp
c0030a9e:	e8 3f f8 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030aa3:	05 5d b5 00 00       	add    $0xb55d,%eax
c0030aa8:	8d 90 88 c9 ff ff    	lea    -0x3678(%eax),%edx
c0030aae:	52                   	push   %edx
c0030aaf:	6a 4b                	push   $0x4b
c0030ab1:	8d 90 97 c7 ff ff    	lea    -0x3869(%eax),%edx
c0030ab7:	52                   	push   %edx
c0030ab8:	8d 90 08 c9 ff ff    	lea    -0x36f8(%eax),%edx
c0030abe:	52                   	push   %edx
c0030abf:	89 c3                	mov    %eax,%ebx
c0030ac1:	e8 31 07 00 00       	call   c00311f7 <printk>
c0030ac6:	83 c4 10             	add    $0x10,%esp
c0030ac9:	b8 01 00 00 00       	mov    $0x1,%eax
c0030ace:	82 b8 ff ff ff ff 8b 	cmpb   $0x8b,-0x1(%eax)
c0030ad5:	5d                   	pop    %ebp
c0030ad6:	fc                   	cld    
c0030ad7:	c9                   	leave  
c0030ad8:	c3                   	ret    
...
c0030ad9 <out_byte>:
c0030ad9:	55                   	push   %ebp
c0030ada:	89 e5                	mov    %esp,%ebp
c0030adc:	83 ec 08             	sub    $0x8,%esp
c0030adf:	e8 fe f7 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030ae4:	05 1c b5 00 00       	add    $0xb51c,%eax
c0030ae9:	8b 45 08             	mov    0x8(%ebp),%eax
c0030aec:	8b 55 0c             	mov    0xc(%ebp),%edx
c0030aef:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
c0030af3:	88 55 f8             	mov    %dl,-0x8(%ebp)
c0030af6:	8a 45 f8             	mov    -0x8(%ebp),%al
c0030af9:	8b 55 fc             	mov    -0x4(%ebp),%edx
c0030afc:	ee                   	out    %al,(%dx)
c0030afd:	90                   	nop
c0030afe:	c9                   	leave  
c0030aff:	c3                   	ret    

c0030b00 <init_i8259>:
c0030b00:	55                   	push   %ebp
c0030b01:	89 e5                	mov    %esp,%ebp
c0030b03:	e8 da f7 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030b08:	05 f8 b4 00 00       	add    $0xb4f8,%eax
c0030b0d:	68 ff 00 00 00       	push   $0xff
c0030b12:	6a 21                	push   $0x21
c0030b14:	e8 c0 ff ff ff       	call   c0030ad9 <out_byte>
c0030b19:	83 c4 08             	add    $0x8,%esp
c0030b1c:	68 ff 00 00 00       	push   $0xff
c0030b21:	68 a1 00 00 00       	push   $0xa1
c0030b26:	e8 ae ff ff ff       	call   c0030ad9 <out_byte>
c0030b2b:	83 c4 08             	add    $0x8,%esp
c0030b2e:	6a 11                	push   $0x11
c0030b30:	6a 20                	push   $0x20
c0030b32:	e8 a2 ff ff ff       	call   c0030ad9 <out_byte>
c0030b37:	83 c4 08             	add    $0x8,%esp
c0030b3a:	6a 20                	push   $0x20
c0030b3c:	6a 21                	push   $0x21
c0030b3e:	e8 96 ff ff ff       	call   c0030ad9 <out_byte>
c0030b43:	83 c4 08             	add    $0x8,%esp
c0030b46:	6a 04                	push   $0x4
c0030b48:	6a 21                	push   $0x21
c0030b4a:	e8 8a ff ff ff       	call   c0030ad9 <out_byte>
c0030b4f:	83 c4 08             	add    $0x8,%esp
c0030b52:	6a 03                	push   $0x3
c0030b54:	6a 21                	push   $0x21
c0030b56:	e8 7e ff ff ff       	call   c0030ad9 <out_byte>
c0030b5b:	83 c4 08             	add    $0x8,%esp
c0030b5e:	6a 11                	push   $0x11
c0030b60:	68 a0 00 00 00       	push   $0xa0
c0030b65:	e8 6f ff ff ff       	call   c0030ad9 <out_byte>
c0030b6a:	83 c4 08             	add    $0x8,%esp
c0030b6d:	6a 28                	push   $0x28
c0030b6f:	68 a1 00 00 00       	push   $0xa1
c0030b74:	e8 60 ff ff ff       	call   c0030ad9 <out_byte>
c0030b79:	83 c4 08             	add    $0x8,%esp
c0030b7c:	6a 02                	push   $0x2
c0030b7e:	68 a1 00 00 00       	push   $0xa1
c0030b83:	e8 51 ff ff ff       	call   c0030ad9 <out_byte>
c0030b88:	83 c4 08             	add    $0x8,%esp
c0030b8b:	6a 03                	push   $0x3
c0030b8d:	68 a1 00 00 00       	push   $0xa1
c0030b92:	e8 42 ff ff ff       	call   c0030ad9 <out_byte>
c0030b97:	83 c4 08             	add    $0x8,%esp
c0030b9a:	6a 68                	push   $0x68
c0030b9c:	6a 20                	push   $0x20
c0030b9e:	e8 36 ff ff ff       	call   c0030ad9 <out_byte>
c0030ba3:	83 c4 08             	add    $0x8,%esp
c0030ba6:	6a 0a                	push   $0xa
c0030ba8:	6a 20                	push   $0x20
c0030baa:	e8 2a ff ff ff       	call   c0030ad9 <out_byte>
c0030baf:	83 c4 08             	add    $0x8,%esp
c0030bb2:	6a 68                	push   $0x68
c0030bb4:	68 a0 00 00 00       	push   $0xa0
c0030bb9:	e8 1b ff ff ff       	call   c0030ad9 <out_byte>
c0030bbe:	83 c4 08             	add    $0x8,%esp
c0030bc1:	6a 0a                	push   $0xa
c0030bc3:	68 a0 00 00 00       	push   $0xa0
c0030bc8:	e8 0c ff ff ff       	call   c0030ad9 <out_byte>
c0030bcd:	83 c4 08             	add    $0x8,%esp
c0030bd0:	90                   	nop
c0030bd1:	c9                   	leave  
c0030bd2:	c3                   	ret    

c0030bd3 <write_idtr>:
c0030bd3:	55                   	push   %ebp
c0030bd4:	89 e5                	mov    %esp,%ebp
c0030bd6:	e8 07 f7 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030bdb:	05 25 b4 00 00       	add    $0xb425,%eax
c0030be0:	8b 55 0c             	mov    0xc(%ebp),%edx
c0030be3:	4a                   	dec    %edx
c0030be4:	66 89 90 20 1c 01 00 	mov    %dx,0x11c20(%eax)
c0030beb:	8b 55 08             	mov    0x8(%ebp),%edx
c0030bee:	66 89 90 22 1c 01 00 	mov    %dx,0x11c22(%eax)
c0030bf5:	8b 55 08             	mov    0x8(%ebp),%edx
c0030bf8:	c1 ea 10             	shr    $0x10,%edx
c0030bfb:	66 89 90 24 1c 01 00 	mov    %dx,0x11c24(%eax)
c0030c02:	8d 80 20 1c 01 00    	lea    0x11c20(%eax),%eax
c0030c08:	0f 01 18             	lidtl  (%eax)
c0030c0b:	90                   	nop
c0030c0c:	5d                   	pop    %ebp
c0030c0d:	c3                   	ret    

c0030c0e <sti>:
c0030c0e:	55                   	push   %ebp
c0030c0f:	89 e5                	mov    %esp,%ebp
c0030c11:	e8 cc f6 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030c16:	05 ea b3 00 00       	add    $0xb3ea,%eax
c0030c1b:	fb                   	sti    
c0030c1c:	90                   	nop
c0030c1d:	5d                   	pop    %ebp
c0030c1e:	c3                   	ret    
...
c0030c1f <set_intr>:
c0030c1f:	55                   	push   %ebp
c0030c20:	89 e5                	mov    %esp,%ebp
c0030c22:	e8 bb f6 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030c27:	05 d9 b3 00 00       	add    $0xb3d9,%eax
c0030c2c:	8b 45 10             	mov    0x10(%ebp),%eax
c0030c2f:	8b 55 08             	mov    0x8(%ebp),%edx
c0030c32:	66 89 02             	mov    %ax,(%edx)
c0030c35:	8b 45 0c             	mov    0xc(%ebp),%eax
c0030c38:	8b 55 08             	mov    0x8(%ebp),%edx
c0030c3b:	66 89 42 02          	mov    %ax,0x2(%edx)
c0030c3f:	8b 45 08             	mov    0x8(%ebp),%eax
c0030c42:	c6 40 04 00          	movb   $0x0,0x4(%eax)
c0030c46:	8b 45 08             	mov    0x8(%ebp),%eax
c0030c49:	8a 50 05             	mov    0x5(%eax),%dl
c0030c4c:	83 e2 f0             	and    $0xfffffff0,%edx
c0030c4f:	83 ca 0e             	or     $0xe,%edx
c0030c52:	88 50 05             	mov    %dl,0x5(%eax)
c0030c55:	8b 45 08             	mov    0x8(%ebp),%eax
c0030c58:	8a 50 05             	mov    0x5(%eax),%dl
c0030c5b:	83 e2 ef             	and    $0xffffffef,%edx
c0030c5e:	88 50 05             	mov    %dl,0x5(%eax)
c0030c61:	8b 45 14             	mov    0x14(%ebp),%eax
c0030c64:	83 e0 03             	and    $0x3,%eax
c0030c67:	88 c2                	mov    %al,%dl
c0030c69:	8b 45 08             	mov    0x8(%ebp),%eax
c0030c6c:	83 e2 03             	and    $0x3,%edx
c0030c6f:	88 d1                	mov    %dl,%cl
c0030c71:	c1 e1 05             	shl    $0x5,%ecx
c0030c74:	8a 50 05             	mov    0x5(%eax),%dl
c0030c77:	83 e2 9f             	and    $0xffffff9f,%edx
c0030c7a:	09 ca                	or     %ecx,%edx
c0030c7c:	88 50 05             	mov    %dl,0x5(%eax)
c0030c7f:	8b 45 08             	mov    0x8(%ebp),%eax
c0030c82:	8a 50 05             	mov    0x5(%eax),%dl
c0030c85:	83 ca 80             	or     $0xffffff80,%edx
c0030c88:	88 50 05             	mov    %dl,0x5(%eax)
c0030c8b:	8b 45 10             	mov    0x10(%ebp),%eax
c0030c8e:	c1 e8 10             	shr    $0x10,%eax
c0030c91:	8b 55 08             	mov    0x8(%ebp),%edx
c0030c94:	66 89 42 06          	mov    %ax,0x6(%edx)
c0030c98:	90                   	nop
c0030c99:	5d                   	pop    %ebp
c0030c9a:	c3                   	ret    

c0030c9b <set_trap>:
c0030c9b:	55                   	push   %ebp
c0030c9c:	89 e5                	mov    %esp,%ebp
c0030c9e:	e8 3f f6 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0030ca3:	05 5d b3 00 00       	add    $0xb35d,%eax
c0030ca8:	8b 45 10             	mov    0x10(%ebp),%eax
c0030cab:	8b 55 08             	mov    0x8(%ebp),%edx
c0030cae:	66 89 02             	mov    %ax,(%edx)
c0030cb1:	8b 45 0c             	mov    0xc(%ebp),%eax
c0030cb4:	8b 55 08             	mov    0x8(%ebp),%edx
c0030cb7:	66 89 42 02          	mov    %ax,0x2(%edx)
c0030cbb:	8b 45 08             	mov    0x8(%ebp),%eax
c0030cbe:	c6 40 04 00          	movb   $0x0,0x4(%eax)
c0030cc2:	8b 45 08             	mov    0x8(%ebp),%eax
c0030cc5:	8a 50 05             	mov    0x5(%eax),%dl
c0030cc8:	83 ca 0f             	or     $0xf,%edx
c0030ccb:	88 50 05             	mov    %dl,0x5(%eax)
c0030cce:	8b 45 08             	mov    0x8(%ebp),%eax
c0030cd1:	8a 50 05             	mov    0x5(%eax),%dl
c0030cd4:	83 e2 ef             	and    $0xffffffef,%edx
c0030cd7:	88 50 05             	mov    %dl,0x5(%eax)
c0030cda:	8b 45 14             	mov    0x14(%ebp),%eax
c0030cdd:	83 e0 03             	and    $0x3,%eax
c0030ce0:	88 c2                	mov    %al,%dl
c0030ce2:	8b 45 08             	mov    0x8(%ebp),%eax
c0030ce5:	83 e2 03             	and    $0x3,%edx
c0030ce8:	88 d1                	mov    %dl,%cl
c0030cea:	c1 e1 05             	shl    $0x5,%ecx
c0030ced:	8a 50 05             	mov    0x5(%eax),%dl
c0030cf0:	83 e2 9f             	and    $0xffffff9f,%edx
c0030cf3:	09 ca                	or     %ecx,%edx
c0030cf5:	88 50 05             	mov    %dl,0x5(%eax)
c0030cf8:	8b 45 08             	mov    0x8(%ebp),%eax
c0030cfb:	8a 50 05             	mov    0x5(%eax),%dl
c0030cfe:	83 ca 80             	or     $0xffffff80,%edx
c0030d01:	88 50 05             	mov    %dl,0x5(%eax)
c0030d04:	8b 45 10             	mov    0x10(%ebp),%eax
c0030d07:	c1 e8 10             	shr    $0x10,%eax
c0030d0a:	8b 55 08             	mov    0x8(%ebp),%edx
c0030d0d:	66 89 42 06          	mov    %ax,0x6(%edx)
c0030d11:	90                   	nop
c0030d12:	5d                   	pop    %ebp
c0030d13:	c3                   	ret    

c0030d14 <init_idt>:
c0030d14:	55                   	push   %ebp
c0030d15:	89 e5                	mov    %esp,%ebp
c0030d17:	53                   	push   %ebx
c0030d18:	83 ec 10             	sub    $0x10,%esp
c0030d1b:	e8 ca f5 ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0030d20:	81 c3 e0 b2 00 00    	add    $0xb2e0,%ebx
c0030d26:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
c0030d2d:	eb 2b                	jmp    c0030d5a <init_idt+0x46>
c0030d2f:	c7 c0 c4 00 03 c0    	mov    $0xc00300c4,%eax
c0030d35:	89 c2                	mov    %eax,%edx
c0030d37:	8b 45 f8             	mov    -0x8(%ebp),%eax
c0030d3a:	8d 0c c5 00 00 00 00 	lea    0x0(,%eax,8),%ecx
c0030d41:	8d 83 20 14 01 00    	lea    0x11420(%ebx),%eax
c0030d47:	01 c8                	add    %ecx,%eax
c0030d49:	6a 00                	push   $0x0
c0030d4b:	52                   	push   %edx
c0030d4c:	6a 08                	push   $0x8
c0030d4e:	50                   	push   %eax
c0030d4f:	e8 47 ff ff ff       	call   c0030c9b <set_trap>
c0030d54:	83 c4 10             	add    $0x10,%esp
c0030d57:	ff 45 f8             	incl   -0x8(%ebp)
c0030d5a:	81 7d f8 ff 00 00 00 	cmpl   $0xff,-0x8(%ebp)
c0030d61:	7e cc                	jle    c0030d2f <init_idt+0x1b>
c0030d63:	c7 c0 52 00 03 c0    	mov    $0xc0030052,%eax
c0030d69:	6a 00                	push   $0x0
c0030d6b:	50                   	push   %eax
c0030d6c:	6a 08                	push   $0x8
c0030d6e:	8d 83 20 14 01 00    	lea    0x11420(%ebx),%eax
c0030d74:	50                   	push   %eax
c0030d75:	e8 21 ff ff ff       	call   c0030c9b <set_trap>
c0030d7a:	83 c4 10             	add    $0x10,%esp
c0030d7d:	c7 c0 58 00 03 c0    	mov    $0xc0030058,%eax
c0030d83:	89 c2                	mov    %eax,%edx
c0030d85:	8d 83 28 14 01 00    	lea    0x11428(%ebx),%eax
c0030d8b:	6a 00                	push   $0x0
c0030d8d:	52                   	push   %edx
c0030d8e:	6a 08                	push   $0x8
c0030d90:	50                   	push   %eax
c0030d91:	e8 05 ff ff ff       	call   c0030c9b <set_trap>
c0030d96:	83 c4 10             	add    $0x10,%esp
c0030d99:	c7 c0 5e 00 03 c0    	mov    $0xc003005e,%eax
c0030d9f:	89 c2                	mov    %eax,%edx
c0030da1:	8d 83 30 14 01 00    	lea    0x11430(%ebx),%eax
c0030da7:	6a 00                	push   $0x0
c0030da9:	52                   	push   %edx
c0030daa:	6a 08                	push   $0x8
c0030dac:	50                   	push   %eax
c0030dad:	e8 e9 fe ff ff       	call   c0030c9b <set_trap>
c0030db2:	83 c4 10             	add    $0x10,%esp
c0030db5:	c7 c0 64 00 03 c0    	mov    $0xc0030064,%eax
c0030dbb:	89 c2                	mov    %eax,%edx
c0030dbd:	8d 83 38 14 01 00    	lea    0x11438(%ebx),%eax
c0030dc3:	6a 00                	push   $0x0
c0030dc5:	52                   	push   %edx
c0030dc6:	6a 08                	push   $0x8
c0030dc8:	50                   	push   %eax
c0030dc9:	e8 cd fe ff ff       	call   c0030c9b <set_trap>
c0030dce:	83 c4 10             	add    $0x10,%esp
c0030dd1:	c7 c0 6a 00 03 c0    	mov    $0xc003006a,%eax
c0030dd7:	89 c2                	mov    %eax,%edx
c0030dd9:	8d 83 40 14 01 00    	lea    0x11440(%ebx),%eax
c0030ddf:	6a 00                	push   $0x0
c0030de1:	52                   	push   %edx
c0030de2:	6a 08                	push   $0x8
c0030de4:	50                   	push   %eax
c0030de5:	e8 b1 fe ff ff       	call   c0030c9b <set_trap>
c0030dea:	83 c4 10             	add    $0x10,%esp
c0030ded:	c7 c0 70 00 03 c0    	mov    $0xc0030070,%eax
c0030df3:	89 c2                	mov    %eax,%edx
c0030df5:	8d 83 48 14 01 00    	lea    0x11448(%ebx),%eax
c0030dfb:	6a 00                	push   $0x0
c0030dfd:	52                   	push   %edx
c0030dfe:	6a 08                	push   $0x8
c0030e00:	50                   	push   %eax
c0030e01:	e8 95 fe ff ff       	call   c0030c9b <set_trap>
c0030e06:	83 c4 10             	add    $0x10,%esp
c0030e09:	c7 c0 76 00 03 c0    	mov    $0xc0030076,%eax
c0030e0f:	89 c2                	mov    %eax,%edx
c0030e11:	8d 83 50 14 01 00    	lea    0x11450(%ebx),%eax
c0030e17:	6a 00                	push   $0x0
c0030e19:	52                   	push   %edx
c0030e1a:	6a 08                	push   $0x8
c0030e1c:	50                   	push   %eax
c0030e1d:	e8 79 fe ff ff       	call   c0030c9b <set_trap>
c0030e22:	83 c4 10             	add    $0x10,%esp
c0030e25:	c7 c0 7c 00 03 c0    	mov    $0xc003007c,%eax
c0030e2b:	89 c2                	mov    %eax,%edx
c0030e2d:	8d 83 58 14 01 00    	lea    0x11458(%ebx),%eax
c0030e33:	6a 00                	push   $0x0
c0030e35:	52                   	push   %edx
c0030e36:	6a 08                	push   $0x8
c0030e38:	50                   	push   %eax
c0030e39:	e8 5d fe ff ff       	call   c0030c9b <set_trap>
c0030e3e:	83 c4 10             	add    $0x10,%esp
c0030e41:	c7 c0 82 00 03 c0    	mov    $0xc0030082,%eax
c0030e47:	89 c2                	mov    %eax,%edx
c0030e49:	8d 83 60 14 01 00    	lea    0x11460(%ebx),%eax
c0030e4f:	6a 00                	push   $0x0
c0030e51:	52                   	push   %edx
c0030e52:	6a 08                	push   $0x8
c0030e54:	50                   	push   %eax
c0030e55:	e8 41 fe ff ff       	call   c0030c9b <set_trap>
c0030e5a:	83 c4 10             	add    $0x10,%esp
c0030e5d:	c7 c0 86 00 03 c0    	mov    $0xc0030086,%eax
c0030e63:	89 c2                	mov    %eax,%edx
c0030e65:	8d 83 68 14 01 00    	lea    0x11468(%ebx),%eax
c0030e6b:	6a 00                	push   $0x0
c0030e6d:	52                   	push   %edx
c0030e6e:	6a 08                	push   $0x8
c0030e70:	50                   	push   %eax
c0030e71:	e8 25 fe ff ff       	call   c0030c9b <set_trap>
c0030e76:	83 c4 10             	add    $0x10,%esp
c0030e79:	c7 c0 8c 00 03 c0    	mov    $0xc003008c,%eax
c0030e7f:	89 c2                	mov    %eax,%edx
c0030e81:	8d 83 70 14 01 00    	lea    0x11470(%ebx),%eax
c0030e87:	6a 00                	push   $0x0
c0030e89:	52                   	push   %edx
c0030e8a:	6a 08                	push   $0x8
c0030e8c:	50                   	push   %eax
c0030e8d:	e8 09 fe ff ff       	call   c0030c9b <set_trap>
c0030e92:	83 c4 10             	add    $0x10,%esp
c0030e95:	c7 c0 90 00 03 c0    	mov    $0xc0030090,%eax
c0030e9b:	89 c2                	mov    %eax,%edx
c0030e9d:	8d 83 78 14 01 00    	lea    0x11478(%ebx),%eax
c0030ea3:	6a 00                	push   $0x0
c0030ea5:	52                   	push   %edx
c0030ea6:	6a 08                	push   $0x8
c0030ea8:	50                   	push   %eax
c0030ea9:	e8 ed fd ff ff       	call   c0030c9b <set_trap>
c0030eae:	83 c4 10             	add    $0x10,%esp
c0030eb1:	c7 c0 94 00 03 c0    	mov    $0xc0030094,%eax
c0030eb7:	89 c2                	mov    %eax,%edx
c0030eb9:	8d 83 80 14 01 00    	lea    0x11480(%ebx),%eax
c0030ebf:	6a 00                	push   $0x0
c0030ec1:	52                   	push   %edx
c0030ec2:	6a 08                	push   $0x8
c0030ec4:	50                   	push   %eax
c0030ec5:	e8 d1 fd ff ff       	call   c0030c9b <set_trap>
c0030eca:	83 c4 10             	add    $0x10,%esp
c0030ecd:	c7 c0 98 00 03 c0    	mov    $0xc0030098,%eax
c0030ed3:	89 c2                	mov    %eax,%edx
c0030ed5:	8d 83 88 14 01 00    	lea    0x11488(%ebx),%eax
c0030edb:	6a 00                	push   $0x0
c0030edd:	52                   	push   %edx
c0030ede:	6a 08                	push   $0x8
c0030ee0:	50                   	push   %eax
c0030ee1:	e8 b5 fd ff ff       	call   c0030c9b <set_trap>
c0030ee6:	83 c4 10             	add    $0x10,%esp
c0030ee9:	c7 c0 9c 00 03 c0    	mov    $0xc003009c,%eax
c0030eef:	89 c2                	mov    %eax,%edx
c0030ef1:	8d 83 90 14 01 00    	lea    0x11490(%ebx),%eax
c0030ef7:	6a 00                	push   $0x0
c0030ef9:	52                   	push   %edx
c0030efa:	6a 08                	push   $0x8
c0030efc:	50                   	push   %eax
c0030efd:	e8 99 fd ff ff       	call   c0030c9b <set_trap>
c0030f02:	83 c4 10             	add    $0x10,%esp
c0030f05:	c7 c0 a0 00 03 c0    	mov    $0xc00300a0,%eax
c0030f0b:	89 c2                	mov    %eax,%edx
c0030f0d:	8d 83 20 18 01 00    	lea    0x11820(%ebx),%eax
c0030f13:	6a 03                	push   $0x3
c0030f15:	52                   	push   %edx
c0030f16:	6a 08                	push   $0x8
c0030f18:	50                   	push   %eax
c0030f19:	e8 7d fd ff ff       	call   c0030c9b <set_trap>
c0030f1e:	83 c4 10             	add    $0x10,%esp
c0030f21:	c7 c0 a9 00 03 c0    	mov    $0xc00300a9,%eax
c0030f27:	89 c2                	mov    %eax,%edx
c0030f29:	8d 83 20 15 01 00    	lea    0x11520(%ebx),%eax
c0030f2f:	6a 00                	push   $0x0
c0030f31:	52                   	push   %edx
c0030f32:	6a 08                	push   $0x8
c0030f34:	50                   	push   %eax
c0030f35:	e8 e5 fc ff ff       	call   c0030c1f <set_intr>
c0030f3a:	83 c4 10             	add    $0x10,%esp
c0030f3d:	c7 c0 b2 00 03 c0    	mov    $0xc00300b2,%eax
c0030f43:	89 c2                	mov    %eax,%edx
c0030f45:	8d 83 28 15 01 00    	lea    0x11528(%ebx),%eax
c0030f4b:	6a 00                	push   $0x0
c0030f4d:	52                   	push   %edx
c0030f4e:	6a 08                	push   $0x8
c0030f50:	50                   	push   %eax
c0030f51:	e8 c9 fc ff ff       	call   c0030c1f <set_intr>
c0030f56:	83 c4 10             	add    $0x10,%esp
c0030f59:	c7 c0 bb 00 03 c0    	mov    $0xc00300bb,%eax
c0030f5f:	89 c2                	mov    %eax,%edx
c0030f61:	8d 83 90 15 01 00    	lea    0x11590(%ebx),%eax
c0030f67:	6a 00                	push   $0x0
c0030f69:	52                   	push   %edx
c0030f6a:	6a 08                	push   $0x8
c0030f6c:	50                   	push   %eax
c0030f6d:	e8 ad fc ff ff       	call   c0030c1f <set_intr>
c0030f72:	83 c4 10             	add    $0x10,%esp
c0030f75:	68 00 08 00 00       	push   $0x800
c0030f7a:	8d 83 20 14 01 00    	lea    0x11420(%ebx),%eax
c0030f80:	50                   	push   %eax
c0030f81:	e8 4d fc ff ff       	call   c0030bd3 <write_idtr>
c0030f86:	83 c4 08             	add    $0x8,%esp
c0030f89:	e8 80 fc ff ff       	call   c0030c0e <sti>
c0030f8e:	90                   	nop
c0030f8f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0030f92:	c9                   	leave  
c0030f93:	c3                   	ret    

c0030f94 <add_irq_handle>:
c0030f94:	55                   	push   %ebp
c0030f95:	89 e5                	mov    %esp,%ebp
c0030f97:	53                   	push   %ebx
c0030f98:	83 ec 14             	sub    $0x14,%esp
c0030f9b:	e8 4a f3 ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0030fa0:	81 c3 60 b0 00 00    	add    $0xb060,%ebx
c0030fa6:	83 7d 08 0f          	cmpl   $0xf,0x8(%ebp)
c0030faa:	7e 2f                	jle    c0030fdb <add_irq_handle+0x47>
c0030fac:	83 ec 0c             	sub    $0xc,%esp
c0030faf:	8d 83 94 c9 ff ff    	lea    -0x366c(%ebx),%eax
c0030fb5:	50                   	push   %eax
c0030fb6:	8d 83 80 cb ff ff    	lea    -0x3480(%ebx),%eax
c0030fbc:	50                   	push   %eax
c0030fbd:	6a 16                	push   $0x16
c0030fbf:	8d 83 a7 c9 ff ff    	lea    -0x3659(%ebx),%eax
c0030fc5:	50                   	push   %eax
c0030fc6:	8d 83 bc c9 ff ff    	lea    -0x3644(%ebx),%eax
c0030fcc:	50                   	push   %eax
c0030fcd:	e8 25 02 00 00       	call   c00311f7 <printk>
c0030fd2:	83 c4 20             	add    $0x20,%esp
c0030fd5:	b8 01 00 00 00       	mov    $0x1,%eax
c0030fda:	82 8b 83 80 1d 01 00 	orb    $0x0,0x11d8083(%ebx)
c0030fe1:	83 f8 20             	cmp    $0x20,%eax
c0030fe4:	7e 2f                	jle    c0031015 <add_irq_handle+0x81>
c0030fe6:	83 ec 0c             	sub    $0xc,%esp
c0030fe9:	8d 83 06 ca ff ff    	lea    -0x35fa(%ebx),%eax
c0030fef:	50                   	push   %eax
c0030ff0:	8d 83 80 cb ff ff    	lea    -0x3480(%ebx),%eax
c0030ff6:	50                   	push   %eax
c0030ff7:	6a 17                	push   $0x17
c0030ff9:	8d 83 a7 c9 ff ff    	lea    -0x3659(%ebx),%eax
c0030fff:	50                   	push   %eax
c0031000:	8d 83 bc c9 ff ff    	lea    -0x3644(%ebx),%eax
c0031006:	50                   	push   %eax
c0031007:	e8 eb 01 00 00       	call   c00311f7 <printk>
c003100c:	83 c4 20             	add    $0x20,%esp
c003100f:	b8 01 00 00 00       	mov    $0x1,%eax
c0031014:	82 8b 83 80 1d 01 00 	orb    $0x0,0x11d8083(%ebx)
c003101b:	8d 50 01             	lea    0x1(%eax),%edx
c003101e:	89 93 80 1d 01 00    	mov    %edx,0x11d80(%ebx)
c0031024:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
c003102b:	8d 83 40 1c 01 00    	lea    0x11c40(%ebx),%eax
c0031031:	01 d0                	add    %edx,%eax
c0031033:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0031036:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0031039:	8b 55 0c             	mov    0xc(%ebp),%edx
c003103c:	89 10                	mov    %edx,(%eax)
c003103e:	8b 45 08             	mov    0x8(%ebp),%eax
c0031041:	8b 94 83 40 1d 01 00 	mov    0x11d40(%ebx,%eax,4),%edx
c0031048:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003104b:	89 50 04             	mov    %edx,0x4(%eax)
c003104e:	8b 45 08             	mov    0x8(%ebp),%eax
c0031051:	8b 55 f4             	mov    -0xc(%ebp),%edx
c0031054:	89 94 83 40 1d 01 00 	mov    %edx,0x11d40(%ebx,%eax,4)
c003105b:	90                   	nop
c003105c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c003105f:	c9                   	leave  
c0031060:	c3                   	ret    

c0031061 <irq_handle>:
c0031061:	55                   	push   %ebp
c0031062:	89 e5                	mov    %esp,%ebp
c0031064:	53                   	push   %ebx
c0031065:	83 ec 14             	sub    $0x14,%esp
c0031068:	e8 7d f2 ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c003106d:	81 c3 93 af 00 00    	add    $0xaf93,%ebx
c0031073:	8b 45 08             	mov    0x8(%ebp),%eax
c0031076:	8b 40 20             	mov    0x20(%eax),%eax
c0031079:	89 45 f0             	mov    %eax,-0x10(%ebp)
c003107c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
c0031080:	79 2a                	jns    c00310ac <irq_handle+0x4b>
c0031082:	8d 83 90 cb ff ff    	lea    -0x3470(%ebx),%eax
c0031088:	50                   	push   %eax
c0031089:	6a 24                	push   $0x24
c003108b:	8d 83 a7 c9 ff ff    	lea    -0x3659(%ebx),%eax
c0031091:	50                   	push   %eax
c0031092:	8d 83 24 ca ff ff    	lea    -0x35dc(%ebx),%eax
c0031098:	50                   	push   %eax
c0031099:	e8 59 01 00 00       	call   c00311f7 <printk>
c003109e:	83 c4 10             	add    $0x10,%esp
c00310a1:	b8 01 00 00 00       	mov    $0x1,%eax
c00310a6:	82 e9 f9             	sub    $0xf9,%cl
c00310a9:	00 00                	add    %al,(%eax)
c00310ab:	00 81 7d f0 80 00    	add    %al,0x80f07d(%ecx)
c00310b1:	00 00                	add    %al,(%eax)
c00310b3:	75 13                	jne    c00310c8 <irq_handle+0x67>
c00310b5:	83 ec 0c             	sub    $0xc,%esp
c00310b8:	ff 75 08             	pushl  0x8(%ebp)
c00310bb:	e8 71 09 00 00       	call   c0031a31 <do_syscall>
c00310c0:	83 c4 10             	add    $0x10,%esp
c00310c3:	e9 dd 00 00 00       	jmp    c00311a5 <irq_handle+0x144>
c00310c8:	81 7d f0 e7 03 00 00 	cmpl   $0x3e7,-0x10(%ebp)
c00310cf:	7f 37                	jg     c0031108 <irq_handle+0xa7>
c00310d1:	8b 45 08             	mov    0x8(%ebp),%eax
c00310d4:	8b 40 28             	mov    0x28(%eax),%eax
c00310d7:	83 ec 08             	sub    $0x8,%esp
c00310da:	50                   	push   %eax
c00310db:	ff 75 f0             	pushl  -0x10(%ebp)
c00310de:	8d 83 90 cb ff ff    	lea    -0x3470(%ebx),%eax
c00310e4:	50                   	push   %eax
c00310e5:	6a 28                	push   $0x28
c00310e7:	8d 83 a7 c9 ff ff    	lea    -0x3659(%ebx),%eax
c00310ed:	50                   	push   %eax
c00310ee:	8d 83 70 ca ff ff    	lea    -0x3590(%ebx),%eax
c00310f4:	50                   	push   %eax
c00310f5:	e8 fd 00 00 00       	call   c00311f7 <printk>
c00310fa:	83 c4 20             	add    $0x20,%esp
c00310fd:	b8 01 00 00 00       	mov    $0x1,%eax
c0031102:	82 e9 9d             	sub    $0x9d,%cl
c0031105:	00 00                	add    %al,(%eax)
c0031107:	00 81 7d f0 e7 03    	add    %al,0x3e7f07d(%ecx)
c003110d:	00 00                	add    %al,(%eax)
c003110f:	0f 8e 90 00 00 00    	jle    c00311a5 <irq_handle+0x144>
c0031115:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0031118:	2d e8 03 00 00       	sub    $0x3e8,%eax
c003111d:	89 45 ec             	mov    %eax,-0x14(%ebp)
c0031120:	83 7d ec 0f          	cmpl   $0xf,-0x14(%ebp)
c0031124:	7e 2f                	jle    c0031155 <irq_handle+0xf4>
c0031126:	83 ec 0c             	sub    $0xc,%esp
c0031129:	8d 83 ca ca ff ff    	lea    -0x3536(%ebx),%eax
c003112f:	50                   	push   %eax
c0031130:	8d 83 90 cb ff ff    	lea    -0x3470(%ebx),%eax
c0031136:	50                   	push   %eax
c0031137:	6a 2b                	push   $0x2b
c0031139:	8d 83 a7 c9 ff ff    	lea    -0x3659(%ebx),%eax
c003113f:	50                   	push   %eax
c0031140:	8d 83 bc c9 ff ff    	lea    -0x3644(%ebx),%eax
c0031146:	50                   	push   %eax
c0031147:	e8 ab 00 00 00       	call   c00311f7 <printk>
c003114c:	83 c4 20             	add    $0x20,%esp
c003114f:	b8 01 00 00 00       	mov    $0x1,%eax
c0031154:	82 83 7d ec 00 75 25 	addb   $0x25,0x7500ec7d(%ebx)
c003115b:	8d 83 90 cb ff ff    	lea    -0x3470(%ebx),%eax
c0031161:	50                   	push   %eax
c0031162:	6a 2d                	push   $0x2d
c0031164:	8d 83 a7 c9 ff ff    	lea    -0x3659(%ebx),%eax
c003116a:	50                   	push   %eax
c003116b:	8d 83 e0 ca ff ff    	lea    -0x3520(%ebx),%eax
c0031171:	50                   	push   %eax
c0031172:	e8 80 00 00 00       	call   c00311f7 <printk>
c0031177:	83 c4 10             	add    $0x10,%esp
c003117a:	b8 01 00 00 00       	mov    $0x1,%eax
c003117f:	82 8b 45 ec 8b 84 83 	orb    $0x83,-0x7b7413bb(%ebx)
c0031186:	40                   	inc    %eax
c0031187:	1d 01 00 89 45       	sbb    $0x45890001,%eax
c003118c:	f4                   	hlt    
c003118d:	eb 10                	jmp    c003119f <irq_handle+0x13e>
c003118f:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0031192:	8b 00                	mov    (%eax),%eax
c0031194:	ff d0                	call   *%eax
c0031196:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0031199:	8b 40 04             	mov    0x4(%eax),%eax
c003119c:	89 45 f4             	mov    %eax,-0xc(%ebp)
c003119f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
c00311a3:	75 ea                	jne    c003118f <irq_handle+0x12e>
c00311a5:	90                   	nop
c00311a6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00311a9:	c9                   	leave  
c00311aa:	c3                   	ret    

c00311ab <sbrk>:
c00311ab:	55                   	push   %ebp
c00311ac:	89 e5                	mov    %esp,%ebp
c00311ae:	53                   	push   %ebx
c00311af:	83 ec 04             	sub    $0x4,%esp
c00311b2:	e8 2b f1 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00311b7:	05 49 ae 00 00       	add    $0xae49,%eax
c00311bc:	83 ec 0c             	sub    $0xc,%esp
c00311bf:	8d 90 9c cb ff ff    	lea    -0x3464(%eax),%edx
c00311c5:	52                   	push   %edx
c00311c6:	8d 90 fc cb ff ff    	lea    -0x3404(%eax),%edx
c00311cc:	52                   	push   %edx
c00311cd:	6a 08                	push   $0x8
c00311cf:	8d 90 9e cb ff ff    	lea    -0x3462(%eax),%edx
c00311d5:	52                   	push   %edx
c00311d6:	8d 90 b0 cb ff ff    	lea    -0x3450(%eax),%edx
c00311dc:	52                   	push   %edx
c00311dd:	89 c3                	mov    %eax,%ebx
c00311df:	e8 13 00 00 00       	call   c00311f7 <printk>
c00311e4:	83 c4 20             	add    $0x20,%esp
c00311e7:	b8 01 00 00 00       	mov    $0x1,%eax
c00311ec:	82 b8 00 00 00 00 8b 	cmpb   $0x8b,0x0(%eax)
c00311f3:	5d                   	pop    %ebp
c00311f4:	fc                   	cld    
c00311f5:	c9                   	leave  
c00311f6:	c3                   	ret    
...
c00311f7 <printk>:
c00311f7:	55                   	push   %ebp
c00311f8:	89 e5                	mov    %esp,%ebp
c00311fa:	53                   	push   %ebx
c00311fb:	83 ec 14             	sub    $0x14,%esp
c00311fe:	e8 e7 f0 ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0031203:	81 c3 fd ad 00 00    	add    $0xadfd,%ebx
c0031209:	8d 45 0c             	lea    0xc(%ebp),%eax
c003120c:	89 45 f4             	mov    %eax,-0xc(%ebp)
c003120f:	8b 45 08             	mov    0x8(%ebp),%eax
c0031212:	ff 75 f4             	pushl  -0xc(%ebp)
c0031215:	50                   	push   %eax
c0031216:	68 00 01 00 00       	push   $0x100
c003121b:	8d 83 a0 1d 01 00    	lea    0x11da0(%ebx),%eax
c0031221:	50                   	push   %eax
c0031222:	e8 f9 0c 00 00       	call   c0031f20 <vsnprintf>
c0031227:	83 c4 10             	add    $0x10,%esp
c003122a:	89 45 f0             	mov    %eax,-0x10(%ebp)
c003122d:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0031230:	83 ec 04             	sub    $0x4,%esp
c0031233:	50                   	push   %eax
c0031234:	8d 83 a0 1d 01 00    	lea    0x11da0(%ebx),%eax
c003123a:	50                   	push   %eax
c003123b:	6a 01                	push   $0x1
c003123d:	e8 b1 f7 ff ff       	call   c00309f3 <fs_write>
c0031242:	83 c4 10             	add    $0x10,%esp
c0031245:	90                   	nop
c0031246:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0031249:	c9                   	leave  
c003124a:	c3                   	ret    

c003124b <in_byte>:
c003124b:	55                   	push   %ebp
c003124c:	89 e5                	mov    %esp,%ebp
c003124e:	83 ec 14             	sub    $0x14,%esp
c0031251:	e8 8c f0 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031256:	05 aa ad 00 00       	add    $0xadaa,%eax
c003125b:	8b 45 08             	mov    0x8(%ebp),%eax
c003125e:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
c0031262:	8b 45 ec             	mov    -0x14(%ebp),%eax
c0031265:	89 c2                	mov    %eax,%edx
c0031267:	ec                   	in     (%dx),%al
c0031268:	88 45 ff             	mov    %al,-0x1(%ebp)
c003126b:	8a 45 ff             	mov    -0x1(%ebp),%al
c003126e:	c9                   	leave  
c003126f:	c3                   	ret    

c0031270 <init_serial>:
c0031270:	55                   	push   %ebp
c0031271:	89 e5                	mov    %esp,%ebp
c0031273:	e8 6a f0 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031278:	05 88 ad 00 00       	add    $0xad88,%eax
c003127d:	90                   	nop
c003127e:	5d                   	pop    %ebp
c003127f:	c3                   	ret    

c0031280 <serial_idle>:
c0031280:	55                   	push   %ebp
c0031281:	89 e5                	mov    %esp,%ebp
c0031283:	e8 5a f0 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031288:	05 78 ad 00 00       	add    $0xad78,%eax
c003128d:	68 fd 03 00 00       	push   $0x3fd
c0031292:	e8 b4 ff ff ff       	call   c003124b <in_byte>
c0031297:	83 c4 04             	add    $0x4,%esp
c003129a:	0f b6 c0             	movzbl %al,%eax
c003129d:	83 e0 20             	and    $0x20,%eax
c00312a0:	85 c0                	test   %eax,%eax
c00312a2:	0f 95 c0             	setne  %al
c00312a5:	0f b6 c0             	movzbl %al,%eax
c00312a8:	c9                   	leave  
c00312a9:	c3                   	ret    

c00312aa <serial_printc>:
c00312aa:	55                   	push   %ebp
c00312ab:	89 e5                	mov    %esp,%ebp
c00312ad:	53                   	push   %ebx
c00312ae:	83 ec 14             	sub    $0x14,%esp
c00312b1:	e8 34 f0 ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c00312b6:	81 c3 4a ad 00 00    	add    $0xad4a,%ebx
c00312bc:	8b 45 08             	mov    0x8(%ebp),%eax
c00312bf:	88 45 f4             	mov    %al,-0xc(%ebp)
c00312c2:	90                   	nop
c00312c3:	e8 b8 ff ff ff       	call   c0031280 <serial_idle>
c00312c8:	85 c0                	test   %eax,%eax
c00312ca:	74 f7                	je     c00312c3 <serial_printc+0x19>
c00312cc:	8d 83 74 cc ff ff    	lea    -0x338c(%ebx),%eax
c00312d2:	50                   	push   %eax
c00312d3:	6a 11                	push   $0x11
c00312d5:	8d 83 04 cc ff ff    	lea    -0x33fc(%ebx),%eax
c00312db:	50                   	push   %eax
c00312dc:	8d 83 18 cc ff ff    	lea    -0x33e8(%ebx),%eax
c00312e2:	50                   	push   %eax
c00312e3:	e8 0f ff ff ff       	call   c00311f7 <printk>
c00312e8:	83 c4 10             	add    $0x10,%esp
c00312eb:	b8 01 00 00 00       	mov    $0x1,%eax
c00312f0:	82 90 8b 5d fc c9 c3 	adcb   $0xc3,-0x3603a275(%eax)

c00312f7 <sti>:
c00312f7:	55                   	push   %ebp
c00312f8:	89 e5                	mov    %esp,%ebp
c00312fa:	e8 e3 ef ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00312ff:	05 01 ad 00 00       	add    $0xad01,%eax
c0031304:	fb                   	sti    
c0031305:	90                   	nop
c0031306:	5d                   	pop    %ebp
c0031307:	c3                   	ret    
...
c0031308 <init>:
c0031308:	55                   	push   %ebp
c0031309:	89 e5                	mov    %esp,%ebp
c003130b:	53                   	push   %ebx
c003130c:	83 ec 04             	sub    $0x4,%esp
c003130f:	e8 d6 ef ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0031314:	81 c3 ec ac 00 00    	add    $0xacec,%ebx
c003131a:	e8 0f 01 00 00       	call   c003142e <init_page>
c003131f:	81 c4 00 00 00 c0    	add    $0xc0000000,%esp
c0031325:	8d 83 3a 53 ff bf    	lea    -0x4000acc6(%ebx),%eax
c003132b:	ff e0                	jmp    *%eax
c003132d:	b8 01 00 00 00       	mov    $0x1,%eax
c0031332:	82 90 83 c4 04 5b 5d 	adcb   $0x5d,0x5b04c483(%eax)
c0031339:	c3                   	ret    

c003133a <init_cond>:
c003133a:	55                   	push   %ebp
c003133b:	89 e5                	mov    %esp,%ebp
c003133d:	53                   	push   %ebx
c003133e:	83 ec 14             	sub    $0x14,%esp
c0031341:	e8 a4 ef ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0031346:	81 c3 ba ac 00 00    	add    $0xacba,%ebx
c003134c:	e8 bc 02 00 00       	call   c003160d <init_segment>
c0031351:	e8 be f9 ff ff       	call   c0030d14 <init_idt>
c0031356:	e8 9c ff ff ff       	call   c00312f7 <sti>
c003135b:	e8 9b 03 00 00       	call   c00316fb <init_mm>
c0031360:	8d 83 c4 cc ff ff    	lea    -0x333c(%ebx),%eax
c0031366:	50                   	push   %eax
c0031367:	6a 4b                	push   $0x4b
c0031369:	8d 83 84 cc ff ff    	lea    -0x337c(%ebx),%eax
c003136f:	50                   	push   %eax
c0031370:	8d 83 90 cc ff ff    	lea    -0x3370(%ebx),%eax
c0031376:	50                   	push   %eax
c0031377:	e8 7b fe ff ff       	call   c00311f7 <printk>
c003137c:	83 c4 10             	add    $0x10,%esp
c003137f:	e8 6f f4 ff ff       	call   c00307f3 <loader>
c0031384:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0031387:	bc 00 00 00 c0       	mov    $0xc0000000,%esp
c003138c:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003138f:	ff d0                	call   *%eax
c0031391:	90                   	nop
...
c003139a:	83 ec 10             	sub    $0x10,%esp
c003139d:	e8 40 ef ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00313a2:	05 5e ac 00 00       	add    $0xac5e,%eax
c00313a7:	0f 20 c0             	mov    %cr0,%eax
c00313aa:	89 45 fc             	mov    %eax,-0x4(%ebp)
c00313ad:	8b 45 fc             	mov    -0x4(%ebp),%eax
c00313b0:	c9                   	leave  
c00313b1:	c3                   	ret    
...
c00313b5:	e8 28 ef ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00313ba:	05 46 ac 00 00       	add    $0xac46,%eax
c00313bf:	8b 45 08             	mov    0x8(%ebp),%eax
c00313c2:	0f 22 c0             	mov    %eax,%cr0
c00313c5:	90                   	nop
c00313c6:	5d                   	pop    %ebp
c00313c7:	c3                   	ret    

c00313c8 <write_cr3>:
c00313c8:	55                   	push   %ebp
c00313c9:	89 e5                	mov    %esp,%ebp
c00313cb:	e8 12 ef ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00313d0:	05 30 ac 00 00       	add    $0xac30,%eax
c00313d5:	8b 45 08             	mov    0x8(%ebp),%eax
c00313d8:	0f 22 d8             	mov    %eax,%cr3
c00313db:	90                   	nop
c00313dc:	5d                   	pop    %ebp
c00313dd:	c3                   	ret    

c00313de <write_gdtr>:
c00313de:	55                   	push   %ebp
c00313df:	89 e5                	mov    %esp,%ebp
c00313e1:	e8 fc ee ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00313e6:	05 1a ac 00 00       	add    $0xac1a,%eax
c00313eb:	8b 55 0c             	mov    0xc(%ebp),%edx
c00313ee:	4a                   	dec    %edx
c00313ef:	66 89 90 a0 1e 01 00 	mov    %dx,0x11ea0(%eax)
c00313f6:	8b 55 08             	mov    0x8(%ebp),%edx
c00313f9:	66 89 90 a2 1e 01 00 	mov    %dx,0x11ea2(%eax)
c0031400:	8b 55 08             	mov    0x8(%ebp),%edx
c0031403:	c1 ea 10             	shr    $0x10,%edx
c0031406:	66 89 90 a4 1e 01 00 	mov    %dx,0x11ea4(%eax)
c003140d:	8d 80 a0 1e 01 00    	lea    0x11ea0(%eax),%eax
c0031413:	0f 01 10             	lgdtl  (%eax)
c0031416:	90                   	nop
c0031417:	5d                   	pop    %ebp
c0031418:	c3                   	ret    
...
c003141c:	e8 c1 ee ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031421:	05 df ab 00 00       	add    $0xabdf,%eax
c0031426:	c7 c0 00 10 07 c0    	mov    $0xc0071000,%eax
c003142c:	5d                   	pop    %ebp
c003142d:	c3                   	ret    

c003142e <init_page>:
c003142e:	55                   	push   %ebp
c003142f:	89 e5                	mov    %esp,%ebp
c0031431:	53                   	push   %ebx
c0031432:	83 ec 24             	sub    $0x24,%esp
c0031435:	e8 a8 ee ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003143a:	05 c6 ab 00 00       	add    $0xabc6,%eax
c003143f:	c7 c2 00 10 07 c0    	mov    $0xc0071000,%edx
c0031445:	81 c2 00 00 00 40    	add    $0x40000000,%edx
c003144b:	89 55 e4             	mov    %edx,-0x1c(%ebp)
c003144e:	c7 c2 00 20 07 c0    	mov    $0xc0072000,%edx
c0031454:	81 c2 00 00 00 40    	add    $0x40000000,%edx
c003145a:	89 55 f4             	mov    %edx,-0xc(%ebp)
c003145d:	83 ec 04             	sub    $0x4,%esp
c0031460:	68 00 10 00 00       	push   $0x1000
c0031465:	6a 00                	push   $0x0
c0031467:	ff 75 e4             	pushl  -0x1c(%ebp)
c003146a:	89 c3                	mov    %eax,%ebx
c003146c:	e8 8b 09 00 00       	call   c0031dfc <memset>
c0031471:	83 c4 10             	add    $0x10,%esp
c0031474:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
c003147b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
c0031482:	eb 6e                	jmp    c00314f2 <init_page+0xc4>
c0031484:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0031487:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
c003148e:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c0031491:	01 d0                	add    %edx,%eax
c0031493:	8b 55 f4             	mov    -0xc(%ebp),%edx
c0031496:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
c003149c:	83 ca 07             	or     $0x7,%edx
c003149f:	89 10                	mov    %edx,(%eax)
c00314a1:	8b 45 f0             	mov    -0x10(%ebp),%eax
c00314a4:	05 00 03 00 00       	add    $0x300,%eax
c00314a9:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
c00314b0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c00314b3:	01 d0                	add    %edx,%eax
c00314b5:	8b 55 f4             	mov    -0xc(%ebp),%edx
c00314b8:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
c00314be:	83 ca 07             	or     $0x7,%edx
c00314c1:	89 10                	mov    %edx,(%eax)
c00314c3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
c00314ca:	eb 1a                	jmp    c00314e6 <init_page+0xb8>
c00314cc:	8b 45 e8             	mov    -0x18(%ebp),%eax
c00314cf:	c1 e0 0c             	shl    $0xc,%eax
c00314d2:	83 c8 07             	or     $0x7,%eax
c00314d5:	89 c2                	mov    %eax,%edx
c00314d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
c00314da:	89 10                	mov    %edx,(%eax)
c00314dc:	ff 45 e8             	incl   -0x18(%ebp)
c00314df:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
c00314e3:	ff 45 ec             	incl   -0x14(%ebp)
c00314e6:	81 7d ec ff 03 00 00 	cmpl   $0x3ff,-0x14(%ebp)
c00314ed:	76 dd                	jbe    c00314cc <init_page+0x9e>
c00314ef:	ff 45 f0             	incl   -0x10(%ebp)
c00314f2:	83 7d f0 1f          	cmpl   $0x1f,-0x10(%ebp)
c00314f6:	76 8c                	jbe    c0031484 <init_page+0x56>
c00314f8:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
c00314ff:	8b 45 e4             	mov    -0x1c(%ebp),%eax
c0031502:	c1 e8 0c             	shr    $0xc,%eax
c0031505:	25 ff ff 0f 00       	and    $0xfffff,%eax
c003150a:	c1 e0 0c             	shl    $0xc,%eax
c003150d:	89 c2                	mov    %eax,%edx
c003150f:	8b 45 dc             	mov    -0x24(%ebp),%eax
c0031512:	25 ff 0f 00 00       	and    $0xfff,%eax
c0031517:	09 d0                	or     %edx,%eax
c0031519:	89 45 dc             	mov    %eax,-0x24(%ebp)
c003151c:	8b 45 dc             	mov    -0x24(%ebp),%eax
c003151f:	83 ec 0c             	sub    $0xc,%esp
c0031522:	50                   	push   %eax
c0031523:	e8 a0 fe ff ff       	call   c00313c8 <write_cr3>
c0031528:	83 c4 10             	add    $0x10,%esp
c003152b:	e8 67 fe ff ff       	call   c0031397 <read_cr0>
c0031530:	89 45 e0             	mov    %eax,-0x20(%ebp)
c0031533:	8a 45 e3             	mov    -0x1d(%ebp),%al
c0031536:	83 c8 80             	or     $0xffffff80,%eax
c0031539:	88 45 e3             	mov    %al,-0x1d(%ebp)
c003153c:	8b 45 e0             	mov    -0x20(%ebp),%eax
c003153f:	83 ec 0c             	sub    $0xc,%esp
c0031542:	50                   	push   %eax
c0031543:	e8 6a fe ff ff       	call   c00313b2 <write_cr0>
c0031548:	83 c4 10             	add    $0x10,%esp
c003154b:	90                   	nop
c003154c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c003154f:	c9                   	leave  
c0031550:	c3                   	ret    

c0031551 <set_segment>:
c0031551:	55                   	push   %ebp
c0031552:	89 e5                	mov    %esp,%ebp
c0031554:	e8 89 ed ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031559:	05 a7 aa 00 00       	add    $0xaaa7,%eax
c003155e:	8b 45 08             	mov    0x8(%ebp),%eax
c0031561:	66 c7 00 ff ff       	movw   $0xffff,(%eax)
c0031566:	8b 45 08             	mov    0x8(%ebp),%eax
c0031569:	66 c7 40 02 00 00    	movw   $0x0,0x2(%eax)
c003156f:	8b 45 08             	mov    0x8(%ebp),%eax
c0031572:	c6 40 04 00          	movb   $0x0,0x4(%eax)
c0031576:	8b 45 10             	mov    0x10(%ebp),%eax
c0031579:	83 e0 0f             	and    $0xf,%eax
c003157c:	88 c2                	mov    %al,%dl
c003157e:	8b 45 08             	mov    0x8(%ebp),%eax
c0031581:	88 d1                	mov    %dl,%cl
c0031583:	83 e1 0f             	and    $0xf,%ecx
c0031586:	8a 50 05             	mov    0x5(%eax),%dl
c0031589:	83 e2 f0             	and    $0xfffffff0,%edx
c003158c:	09 ca                	or     %ecx,%edx
c003158e:	88 50 05             	mov    %dl,0x5(%eax)
c0031591:	8b 45 08             	mov    0x8(%ebp),%eax
c0031594:	8a 50 05             	mov    0x5(%eax),%dl
c0031597:	83 ca 10             	or     $0x10,%edx
c003159a:	88 50 05             	mov    %dl,0x5(%eax)
c003159d:	8b 45 0c             	mov    0xc(%ebp),%eax
c00315a0:	83 e0 03             	and    $0x3,%eax
c00315a3:	88 c2                	mov    %al,%dl
c00315a5:	8b 45 08             	mov    0x8(%ebp),%eax
c00315a8:	83 e2 03             	and    $0x3,%edx
c00315ab:	88 d1                	mov    %dl,%cl
c00315ad:	c1 e1 05             	shl    $0x5,%ecx
c00315b0:	8a 50 05             	mov    0x5(%eax),%dl
c00315b3:	83 e2 9f             	and    $0xffffff9f,%edx
c00315b6:	09 ca                	or     %ecx,%edx
c00315b8:	88 50 05             	mov    %dl,0x5(%eax)
c00315bb:	8b 45 08             	mov    0x8(%ebp),%eax
c00315be:	8a 50 05             	mov    0x5(%eax),%dl
c00315c1:	83 ca 80             	or     $0xffffff80,%edx
c00315c4:	88 50 05             	mov    %dl,0x5(%eax)
c00315c7:	8b 45 08             	mov    0x8(%ebp),%eax
c00315ca:	8a 50 06             	mov    0x6(%eax),%dl
c00315cd:	83 ca 0f             	or     $0xf,%edx
c00315d0:	88 50 06             	mov    %dl,0x6(%eax)
c00315d3:	8b 45 08             	mov    0x8(%ebp),%eax
c00315d6:	8a 50 06             	mov    0x6(%eax),%dl
c00315d9:	83 e2 ef             	and    $0xffffffef,%edx
c00315dc:	88 50 06             	mov    %dl,0x6(%eax)
c00315df:	8b 45 08             	mov    0x8(%ebp),%eax
c00315e2:	8a 50 06             	mov    0x6(%eax),%dl
c00315e5:	83 e2 df             	and    $0xffffffdf,%edx
c00315e8:	88 50 06             	mov    %dl,0x6(%eax)
c00315eb:	8b 45 08             	mov    0x8(%ebp),%eax
c00315ee:	8a 50 06             	mov    0x6(%eax),%dl
c00315f1:	83 ca 40             	or     $0x40,%edx
c00315f4:	88 50 06             	mov    %dl,0x6(%eax)
c00315f7:	8b 45 08             	mov    0x8(%ebp),%eax
c00315fa:	8a 50 06             	mov    0x6(%eax),%dl
c00315fd:	83 ca 80             	or     $0xffffff80,%edx
c0031600:	88 50 06             	mov    %dl,0x6(%eax)
c0031603:	8b 45 08             	mov    0x8(%ebp),%eax
c0031606:	c6 40 07 00          	movb   $0x0,0x7(%eax)
c003160a:	90                   	nop
c003160b:	5d                   	pop    %ebp
c003160c:	c3                   	ret    

c003160d <init_segment>:
c003160d:	55                   	push   %ebp
c003160e:	89 e5                	mov    %esp,%ebp
c0031610:	53                   	push   %ebx
c0031611:	83 ec 04             	sub    $0x4,%esp
c0031614:	e8 d1 ec ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0031619:	81 c3 e7 a9 00 00    	add    $0xa9e7,%ebx
c003161f:	83 ec 04             	sub    $0x4,%esp
c0031622:	6a 18                	push   $0x18
c0031624:	6a 00                	push   $0x0
c0031626:	c7 c0 00 00 07 c0    	mov    $0xc0070000,%eax
c003162c:	50                   	push   %eax
c003162d:	e8 ca 07 00 00       	call   c0031dfc <memset>
c0031632:	83 c4 10             	add    $0x10,%esp
c0031635:	83 ec 04             	sub    $0x4,%esp
c0031638:	6a 0a                	push   $0xa
c003163a:	6a 00                	push   $0x0
c003163c:	c7 c0 00 00 07 c0    	mov    $0xc0070000,%eax
c0031642:	8d 40 08             	lea    0x8(%eax),%eax
c0031645:	50                   	push   %eax
c0031646:	e8 06 ff ff ff       	call   c0031551 <set_segment>
c003164b:	83 c4 10             	add    $0x10,%esp
c003164e:	83 ec 04             	sub    $0x4,%esp
c0031651:	6a 02                	push   $0x2
c0031653:	6a 00                	push   $0x0
c0031655:	c7 c0 00 00 07 c0    	mov    $0xc0070000,%eax
c003165b:	8d 40 10             	lea    0x10(%eax),%eax
c003165e:	50                   	push   %eax
c003165f:	e8 ed fe ff ff       	call   c0031551 <set_segment>
c0031664:	83 c4 10             	add    $0x10,%esp
c0031667:	83 ec 08             	sub    $0x8,%esp
c003166a:	6a 18                	push   $0x18
c003166c:	c7 c0 00 00 07 c0    	mov    $0xc0070000,%eax
c0031672:	50                   	push   %eax
c0031673:	e8 66 fd ff ff       	call   c00313de <write_gdtr>
c0031678:	83 c4 10             	add    $0x10,%esp
c003167b:	90                   	nop
c003167c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c003167f:	c9                   	leave  
c0031680:	c3                   	ret    

c0031681 <get_updir>:
c0031681:	55                   	push   %ebp
c0031682:	89 e5                	mov    %esp,%ebp
c0031684:	e8 59 ec ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031689:	05 77 a9 00 00       	add    $0xa977,%eax
c003168e:	c7 c0 00 20 09 c0    	mov    $0xc0092000,%eax
c0031694:	5d                   	pop    %ebp
c0031695:	c3                   	ret    

c0031696 <get_ucr3>:
c0031696:	55                   	push   %ebp
c0031697:	89 e5                	mov    %esp,%ebp
c0031699:	e8 44 ec ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003169e:	05 62 a9 00 00       	add    $0xa962,%eax
c00316a3:	c7 c0 00 30 09 c0    	mov    $0xc0093000,%eax
c00316a9:	8b 00                	mov    (%eax),%eax
c00316ab:	5d                   	pop    %ebp
c00316ac:	c3                   	ret    

c00316ad <mm_brk>:
c00316ad:	55                   	push   %ebp
c00316ae:	89 e5                	mov    %esp,%ebp
c00316b0:	53                   	push   %ebx
c00316b1:	83 ec 04             	sub    $0x4,%esp
c00316b4:	e8 31 ec ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c00316b9:	81 c3 47 a9 00 00    	add    $0xa947,%ebx
c00316bf:	8b 83 a8 1e 01 00    	mov    0x11ea8(%ebx),%eax
c00316c5:	39 45 08             	cmp    %eax,0x8(%ebp)
c00316c8:	76 22                	jbe    c00316ec <mm_brk+0x3f>
c00316ca:	8b 83 a8 1e 01 00    	mov    0x11ea8(%ebx),%eax
c00316d0:	8b 55 08             	mov    0x8(%ebp),%edx
c00316d3:	29 c2                	sub    %eax,%edx
c00316d5:	89 d0                	mov    %edx,%eax
c00316d7:	89 c2                	mov    %eax,%edx
c00316d9:	8b 83 a8 1e 01 00    	mov    0x11ea8(%ebx),%eax
c00316df:	83 ec 08             	sub    $0x8,%esp
c00316e2:	52                   	push   %edx
c00316e3:	50                   	push   %eax
c00316e4:	e8 37 04 00 00       	call   c0031b20 <mm_malloc>
c00316e9:	83 c4 10             	add    $0x10,%esp
c00316ec:	8b 45 08             	mov    0x8(%ebp),%eax
c00316ef:	89 83 a8 1e 01 00    	mov    %eax,0x11ea8(%ebx)
c00316f5:	90                   	nop
c00316f6:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00316f9:	c9                   	leave  
c00316fa:	c3                   	ret    

c00316fb <init_mm>:
c00316fb:	55                   	push   %ebp
c00316fc:	89 e5                	mov    %esp,%ebp
c00316fe:	53                   	push   %ebx
c00316ff:	83 ec 14             	sub    $0x14,%esp
c0031702:	e8 e3 eb ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0031707:	81 c3 f9 a8 00 00    	add    $0xa8f9,%ebx
c003170d:	e8 07 fd ff ff       	call   c0031419 <get_kpdir>
c0031712:	89 45 f4             	mov    %eax,-0xc(%ebp)
c0031715:	83 ec 04             	sub    $0x4,%esp
c0031718:	68 00 10 00 00       	push   $0x1000
c003171d:	6a 00                	push   $0x0
c003171f:	c7 c0 00 20 09 c0    	mov    $0xc0092000,%eax
c0031725:	50                   	push   %eax
c0031726:	e8 d1 06 00 00       	call   c0031dfc <memset>
c003172b:	83 c4 10             	add    $0x10,%esp
c003172e:	8b 45 f4             	mov    -0xc(%ebp),%eax
c0031731:	05 00 0c 00 00       	add    $0xc00,%eax
c0031736:	83 ec 04             	sub    $0x4,%esp
c0031739:	68 80 00 00 00       	push   $0x80
c003173e:	50                   	push   %eax
c003173f:	c7 c0 00 20 09 c0    	mov    $0xc0092000,%eax
c0031745:	8d 80 00 0c 00 00    	lea    0xc00(%eax),%eax
c003174b:	50                   	push   %eax
c003174c:	e8 63 06 00 00       	call   c0031db4 <memcpy>
c0031751:	83 c4 10             	add    $0x10,%esp
c0031754:	c7 c0 00 20 09 c0    	mov    $0xc0092000,%eax
c003175a:	05 00 00 00 40       	add    $0x40000000,%eax
c003175f:	25 00 fc ff ff       	and    $0xfffffc00,%eax
c0031764:	89 c2                	mov    %eax,%edx
c0031766:	c7 c0 00 30 09 c0    	mov    $0xc0093000,%eax
c003176c:	89 10                	mov    %edx,(%eax)
c003176e:	90                   	nop
c003176f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0031772:	c9                   	leave  
c0031773:	c3                   	ret    

c0031774 <create_video_mapping>:
c0031774:	55                   	push   %ebp
c0031775:	89 e5                	mov    %esp,%ebp
c0031777:	53                   	push   %ebx
c0031778:	83 ec 04             	sub    $0x4,%esp
c003177b:	e8 62 eb ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031780:	05 80 a8 00 00       	add    $0xa880,%eax
c0031785:	8d 90 88 cd ff ff    	lea    -0x3278(%eax),%edx
c003178b:	52                   	push   %edx
c003178c:	6a 13                	push   $0x13
c003178e:	8d 90 d0 cc ff ff    	lea    -0x3330(%eax),%edx
c0031794:	52                   	push   %edx
c0031795:	8d 90 e4 cc ff ff    	lea    -0x331c(%eax),%edx
c003179b:	52                   	push   %edx
c003179c:	89 c3                	mov    %eax,%ebx
c003179e:	e8 54 fa ff ff       	call   c00311f7 <printk>
c00317a3:	83 c4 10             	add    $0x10,%esp
c00317a6:	b8 01 00 00 00       	mov    $0x1,%eax
c00317ab:	82 90 8b 5d fc c9 c3 	adcb   $0xc3,-0x3603a275(%eax)

c00317b2 <video_mapping_write_test>:
c00317b2:	55                   	push   %ebp
c00317b3:	89 e5                	mov    %esp,%ebp
c00317b5:	83 ec 10             	sub    $0x10,%esp
c00317b8:	e8 25 eb ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00317bd:	05 43 a8 00 00       	add    $0xa843,%eax
c00317c2:	c7 45 f8 00 00 0a 00 	movl   $0xa0000,-0x8(%ebp)
c00317c9:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
c00317d0:	eb 17                	jmp    c00317e9 <video_mapping_write_test+0x37>
c00317d2:	8b 45 fc             	mov    -0x4(%ebp),%eax
c00317d5:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
c00317dc:	8b 45 f8             	mov    -0x8(%ebp),%eax
c00317df:	01 c2                	add    %eax,%edx
c00317e1:	8b 45 fc             	mov    -0x4(%ebp),%eax
c00317e4:	89 02                	mov    %eax,(%edx)
c00317e6:	ff 45 fc             	incl   -0x4(%ebp)
c00317e9:	81 7d fc 7f 3e 00 00 	cmpl   $0x3e7f,-0x4(%ebp)
c00317f0:	7e e0                	jle    c00317d2 <video_mapping_write_test+0x20>
c00317f2:	90                   	nop
c00317f3:	c9                   	leave  
c00317f4:	c3                   	ret    

c00317f5 <video_mapping_read_test>:
c00317f5:	55                   	push   %ebp
c00317f6:	89 e5                	mov    %esp,%ebp
c00317f8:	53                   	push   %ebx
c00317f9:	83 ec 14             	sub    $0x14,%esp
c00317fc:	e8 e9 ea ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0031801:	81 c3 ff a7 00 00    	add    $0xa7ff,%ebx
c0031807:	c7 45 f0 00 00 0a 00 	movl   $0xa0000,-0x10(%ebp)
c003180e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
c0031815:	eb 4a                	jmp    c0031861 <video_mapping_read_test+0x6c>
c0031817:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003181a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
c0031821:	8b 45 f0             	mov    -0x10(%ebp),%eax
c0031824:	01 d0                	add    %edx,%eax
c0031826:	8b 10                	mov    (%eax),%edx
c0031828:	8b 45 f4             	mov    -0xc(%ebp),%eax
c003182b:	39 c2                	cmp    %eax,%edx
c003182d:	74 2f                	je     c003185e <video_mapping_read_test+0x69>
c003182f:	83 ec 0c             	sub    $0xc,%esp
c0031832:	8d 83 2d cd ff ff    	lea    -0x32d3(%ebx),%eax
c0031838:	50                   	push   %eax
c0031839:	8d 83 a0 cd ff ff    	lea    -0x3260(%ebx),%eax
c003183f:	50                   	push   %eax
c0031840:	6a 22                	push   $0x22
c0031842:	8d 83 d0 cc ff ff    	lea    -0x3330(%ebx),%eax
c0031848:	50                   	push   %eax
c0031849:	8d 83 3c cd ff ff    	lea    -0x32c4(%ebx),%eax
c003184f:	50                   	push   %eax
c0031850:	e8 a2 f9 ff ff       	call   c00311f7 <printk>
c0031855:	83 c4 20             	add    $0x20,%esp
c0031858:	b8 01 00 00 00       	mov    $0x1,%eax
c003185d:	82 ff 45             	cmp    $0x45,%bh
c0031860:	f4                   	hlt    
c0031861:	81 7d f4 7f 3e 00 00 	cmpl   $0x3e7f,-0xc(%ebp)
c0031868:	7e ad                	jle    c0031817 <video_mapping_read_test+0x22>
c003186a:	90                   	nop
c003186b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c003186e:	c9                   	leave  
c003186f:	c3                   	ret    

c0031870 <video_mapping_clear>:
c0031870:	55                   	push   %ebp
c0031871:	89 e5                	mov    %esp,%ebp
c0031873:	53                   	push   %ebx
c0031874:	83 ec 04             	sub    $0x4,%esp
c0031877:	e8 66 ea ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003187c:	05 84 a7 00 00       	add    $0xa784,%eax
c0031881:	83 ec 04             	sub    $0x4,%esp
c0031884:	68 00 fa 00 00       	push   $0xfa00
c0031889:	6a 00                	push   $0x0
c003188b:	68 00 00 0a 00       	push   $0xa0000
c0031890:	89 c3                	mov    %eax,%ebx
c0031892:	e8 65 05 00 00       	call   c0031dfc <memset>
c0031897:	83 c4 10             	add    $0x10,%esp
c003189a:	90                   	nop
c003189b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c003189e:	c9                   	leave  
c003189f:	c3                   	ret    
...
c00318a3:	e8 3a ea ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00318a8:	05 58 a7 00 00       	add    $0xa758,%eax
c00318ad:	fb                   	sti    
c00318ae:	90                   	nop
c00318af:	5d                   	pop    %ebp
c00318b0:	c3                   	ret    
...
c00318b1 <cli>:
c00318b1:	55                   	push   %ebp
c00318b2:	89 e5                	mov    %esp,%ebp
c00318b4:	e8 29 ea ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00318b9:	05 47 a7 00 00       	add    $0xa747,%eax
c00318be:	fa                   	cli    
c00318bf:	90                   	nop
c00318c0:	5d                   	pop    %ebp
c00318c1:	c3                   	ret    
...
c00318c2 <sys_brk>:
c00318c2:	55                   	push   %ebp
c00318c3:	89 e5                	mov    %esp,%ebp
c00318c5:	53                   	push   %ebx
c00318c6:	83 ec 04             	sub    $0x4,%esp
c00318c9:	e8 14 ea ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00318ce:	05 32 a7 00 00       	add    $0xa732,%eax
c00318d3:	8b 55 08             	mov    0x8(%ebp),%edx
c00318d6:	8b 52 10             	mov    0x10(%edx),%edx
c00318d9:	83 ec 0c             	sub    $0xc,%esp
c00318dc:	52                   	push   %edx
c00318dd:	89 c3                	mov    %eax,%ebx
c00318df:	e8 c9 fd ff ff       	call   c00316ad <mm_brk>
c00318e4:	83 c4 10             	add    $0x10,%esp
c00318e7:	8b 45 08             	mov    0x8(%ebp),%eax
c00318ea:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
c00318f1:	90                   	nop
...
c00318fe:	e8 df e9 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031903:	05 fd a6 00 00       	add    $0xa6fd,%eax
c0031908:	8b 55 08             	mov    0x8(%ebp),%edx
c003190b:	8b 52 18             	mov    0x18(%edx),%edx
c003190e:	89 d1                	mov    %edx,%ecx
c0031910:	8b 55 08             	mov    0x8(%ebp),%edx
c0031913:	8b 52 10             	mov    0x10(%edx),%edx
c0031916:	83 ec 08             	sub    $0x8,%esp
c0031919:	51                   	push   %ecx
c003191a:	52                   	push   %edx
c003191b:	89 c3                	mov    %eax,%ebx
c003191d:	e8 19 f0 ff ff       	call   c003093b <fs_open>
c0031922:	83 c4 10             	add    $0x10,%esp
c0031925:	89 c2                	mov    %eax,%edx
c0031927:	8b 45 08             	mov    0x8(%ebp),%eax
c003192a:	89 50 1c             	mov    %edx,0x1c(%eax)
c003192d:	90                   	nop
c003192e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0031931:	c9                   	leave  
c0031932:	c3                   	ret    

c0031933 <sys_read>:
c0031933:	55                   	push   %ebp
c0031934:	89 e5                	mov    %esp,%ebp
c0031936:	53                   	push   %ebx
c0031937:	83 ec 04             	sub    $0x4,%esp
c003193a:	e8 a3 e9 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c003193f:	05 c1 a6 00 00       	add    $0xa6c1,%eax
c0031944:	8b 55 08             	mov    0x8(%ebp),%edx
c0031947:	8b 52 14             	mov    0x14(%edx),%edx
c003194a:	8b 4d 08             	mov    0x8(%ebp),%ecx
c003194d:	8b 49 18             	mov    0x18(%ecx),%ecx
c0031950:	89 cb                	mov    %ecx,%ebx
c0031952:	8b 4d 08             	mov    0x8(%ebp),%ecx
c0031955:	8b 49 10             	mov    0x10(%ecx),%ecx
c0031958:	83 ec 04             	sub    $0x4,%esp
c003195b:	52                   	push   %edx
c003195c:	53                   	push   %ebx
c003195d:	51                   	push   %ecx
c003195e:	89 c3                	mov    %eax,%ebx
c0031960:	e8 18 f0 ff ff       	call   c003097d <fs_read>
c0031965:	83 c4 10             	add    $0x10,%esp
c0031968:	89 c2                	mov    %eax,%edx
c003196a:	8b 45 08             	mov    0x8(%ebp),%eax
c003196d:	89 50 1c             	mov    %edx,0x1c(%eax)
c0031970:	90                   	nop
c0031971:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0031974:	c9                   	leave  
c0031975:	c3                   	ret    

c0031976 <sys_write>:
c0031976:	55                   	push   %ebp
c0031977:	89 e5                	mov    %esp,%ebp
c0031979:	53                   	push   %ebx
c003197a:	83 ec 04             	sub    $0x4,%esp
c003197d:	e8 60 e9 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031982:	05 7e a6 00 00       	add    $0xa67e,%eax
c0031987:	8b 55 08             	mov    0x8(%ebp),%edx
c003198a:	8b 52 14             	mov    0x14(%edx),%edx
c003198d:	8b 4d 08             	mov    0x8(%ebp),%ecx
c0031990:	8b 49 18             	mov    0x18(%ecx),%ecx
c0031993:	89 cb                	mov    %ecx,%ebx
c0031995:	8b 4d 08             	mov    0x8(%ebp),%ecx
c0031998:	8b 49 10             	mov    0x10(%ecx),%ecx
c003199b:	83 ec 04             	sub    $0x4,%esp
c003199e:	52                   	push   %edx
c003199f:	53                   	push   %ebx
c00319a0:	51                   	push   %ecx
c00319a1:	89 c3                	mov    %eax,%ebx
c00319a3:	e8 4b f0 ff ff       	call   c00309f3 <fs_write>
c00319a8:	83 c4 10             	add    $0x10,%esp
c00319ab:	89 c2                	mov    %eax,%edx
c00319ad:	8b 45 08             	mov    0x8(%ebp),%eax
c00319b0:	89 50 1c             	mov    %edx,0x1c(%eax)
c00319b3:	90                   	nop
c00319b4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00319b7:	c9                   	leave  
c00319b8:	c3                   	ret    

c00319b9 <sys_lseek>:
c00319b9:	55                   	push   %ebp
c00319ba:	89 e5                	mov    %esp,%ebp
c00319bc:	53                   	push   %ebx
c00319bd:	83 ec 04             	sub    $0x4,%esp
c00319c0:	e8 1d e9 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c00319c5:	05 3b a6 00 00       	add    $0xa63b,%eax
c00319ca:	8b 55 08             	mov    0x8(%ebp),%edx
c00319cd:	8b 52 14             	mov    0x14(%edx),%edx
c00319d0:	89 d3                	mov    %edx,%ebx
c00319d2:	8b 55 08             	mov    0x8(%ebp),%edx
c00319d5:	8b 52 18             	mov    0x18(%edx),%edx
c00319d8:	89 d1                	mov    %edx,%ecx
c00319da:	8b 55 08             	mov    0x8(%ebp),%edx
c00319dd:	8b 52 10             	mov    0x10(%edx),%edx
c00319e0:	83 ec 04             	sub    $0x4,%esp
c00319e3:	53                   	push   %ebx
c00319e4:	51                   	push   %ecx
c00319e5:	52                   	push   %edx
c00319e6:	89 c3                	mov    %eax,%ebx
c00319e8:	e8 68 f0 ff ff       	call   c0030a55 <fs_lseek>
c00319ed:	83 c4 10             	add    $0x10,%esp
c00319f0:	89 c2                	mov    %eax,%edx
c00319f2:	8b 45 08             	mov    0x8(%ebp),%eax
c00319f5:	89 50 1c             	mov    %edx,0x1c(%eax)
c00319f8:	90                   	nop
c00319f9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c00319fc:	c9                   	leave  
c00319fd:	c3                   	ret    

c00319fe <sys_close>:
c00319fe:	55                   	push   %ebp
c00319ff:	89 e5                	mov    %esp,%ebp
c0031a01:	53                   	push   %ebx
c0031a02:	83 ec 04             	sub    $0x4,%esp
c0031a05:	e8 d8 e8 ff ff       	call   c00302e2 <__x86.get_pc_thunk.ax>
c0031a0a:	05 f6 a5 00 00       	add    $0xa5f6,%eax
c0031a0f:	8b 55 08             	mov    0x8(%ebp),%edx
c0031a12:	8b 52 10             	mov    0x10(%edx),%edx
c0031a15:	83 ec 0c             	sub    $0xc,%esp
c0031a18:	52                   	push   %edx
c0031a19:	89 c3                	mov    %eax,%ebx
c0031a1b:	e8 77 f0 ff ff       	call   c0030a97 <fs_close>
c0031a20:	83 c4 10             	add    $0x10,%esp
c0031a23:	89 c2                	mov    %eax,%edx
c0031a25:	8b 45 08             	mov    0x8(%ebp),%eax
c0031a28:	89 50 1c             	mov    %edx,0x1c(%eax)
c0031a2b:	90                   	nop
c0031a2c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
c0031a2f:	c9                   	leave  
c0031a30:	c3                   	ret    
...
c0031a34:	53                   	push   %ebx
c0031a35:	83 ec 04             	sub    $0x4,%esp
c0031a38:	e8 ad e8 ff ff       	call   c00302ea <__x86.get_pc_thunk.bx>
c0031a3d:	81 c3 c3 a5 00 00    	add    $0xa5c3,%ebx
c0031a43:	8b 45 08             	mov    0x8(%ebp),%eax
c0031a46:	8b 40 1c             	mov    0x1c(%eax),%eax
c0031a49:	83 f8 2d             	cmp    $0x2d,%eax
c0031a4c:	0f 87 98 00 00 00    	ja     c0031aea <.L10>
c0031a52:	c1 e0 02             	shl    $0x2,%eax
c0031a55:	8b 84 18 28 ce ff ff 	mov    -0x31d8(%eax,%ebx,1),%eax
c0031a5c:	01 d8                	add    %ebx,%eax
c0031a5e:	ff e0                	jmp    *%eax

c0031a60 <.L11>:
c0031a60:	e8 4c fe ff ff       	call   c00318b1 <cli>
c0031a65:	8b 45 08             	mov    0x8(%ebp),%eax
c0031a68:	8b 40 18             	mov    0x18(%eax),%eax
c0031a6b:	89 c2                	mov    %eax,%edx
c0031a6d:	8b 45 08             	mov    0x8(%ebp),%eax
c0031a70:	8b 40 10             	mov    0x10(%eax),%eax
c0031a73:	83 ec 08             	sub    $0x8,%esp
c0031a76:	52                   	push   %edx
c0031a77:	50                   	push   %eax
c0031a78:	e8 17 f5 ff ff       	call   c0030f94 <add_irq_handle>
c0031a7d:	83 c4 10             	add    $0x10,%esp
c0031a80:	e8 1b fe ff ff       	call   c00318a0 <sti>
c0031a85:	e9 8f 00 00 00       	jmp    c0031b19 <.L10+0x2f>

c0031a8a <.L18>:
c0031a8a:	83 ec 0c             	sub    $0xc,%esp
c0031a8d:	ff 75 08             	pushl  0x8(%ebp)
c0031a90:	e8 2d fe ff ff       	call   c00318c2 <sys_brk>
c0031a95:	83 c4 10             	add    $0x10,%esp
c0031a98:	eb 7f                	jmp    c0031b19 <.L10+0x2f>

c0031a9a <.L15>:
c0031a9a:	83 ec 0c             	sub    $0xc,%esp
c0031a9d:	ff 75 08             	pushl  0x8(%ebp)
c0031aa0:	e8 52 fe ff ff       	call   c00318f7 <sys_open>
c0031aa5:	83 c4 10             	add    $0x10,%esp
c0031aa8:	eb 6f                	jmp    c0031b19 <.L10+0x2f>

c0031aaa <.L13>:
c0031aaa:	83 ec 0c             	sub    $0xc,%esp
c0031aad:	ff 75 08             	pushl  0x8(%ebp)
c0031ab0:	e8 7e fe ff ff       	call   c0031933 <sys_read>
c0031ab5:	83 c4 10             	add    $0x10,%esp
c0031ab8:	eb 5f                	jmp    c0031b19 <.L10+0x2f>

c0031aba <.L14>:
c0031aba:	83 ec 0c             	sub    $0xc,%esp
c0031abd:	ff 75 08             	pushl  0x8(%ebp)
c0031ac0:	e8 b1 fe ff ff       	call   c0031976 <sys_write>
c0031ac5:	83 c4 10             	add    $0x10,%esp
c0031ac8:	eb 4f                	jmp    c0031b19 <.L10+0x2f>

c0031aca <.L17>:
c0031aca:	83 ec 0c             	sub    $0xc,%esp
c0031acd:	ff 75 08             	pushl  0x8(%ebp)
c0031ad0:	e8 e4 fe ff ff       	call   c00319b9 <sys_lseek>
c0031ad5:	83 c4 10             	add    $0x10,%esp
c0031ad8:	eb 3f                	jmp    c0031b19 <.L10+0x2f>

c0031ada <.L16>:
c0031ada:	83 ec 0c             	sub    $0xc,%esp
c0031add:	ff 75 08             	pushl  0x8(%ebp)
c0031ae0:	e8 19 ff ff ff       	call   c00319fe <sys_close>
c0031ae5:	83 c4 10             	add    $0x10,%esp
c0031ae8:	eb 2f                	jmp    c0031b19 <.L10+0x2f>

c0031aea <.L10>:
c0031aea:	8b 45 08             	mov    0x8(%ebp),%eax
c0031aed:	8b 40 1c             	mov    0x1c(%eax),%eax
c0031af0:	83 ec 0c             	sub    $0xc,%esp
c0031af3:	50                   	push   %eax
c0031af4:	8d 83 e0 ce ff ff    	lea    -0x3120(%ebx),%eax
c0031afa:	50                   	push   %eax
c0031afb:	6a 35                	push   $0x35
c0031afd:	8d 83 b8 cd ff ff    	lea    -0x3248(%ebx),%eax
c0031b03:	50                   	push   %eax
c0031b04:	8d 83 d4 cd ff ff    	lea    -0x322c(%ebx),%eax
c0031b0a:	50                   	push   %eax
c0031b0b:	e8 e7 f6 ff ff       	call   c00311f7 <printk>
c0031b10:	83 c4 20             	add    $0x20,%esp
c0031b13:	b8 01 00 00 00       	mov    $0x1,%eax
c0031b18:	82 90 8b 5d fc c9 c3 	adcb   $0xc3,-0x3603a275(%eax)
c0031b1f:	90                   	nop
...
c0031b36:	e8 46 fb ff ff       	call   c0031681 <get_updir>
c0031b3b:	89 c6                	mov    %eax,%esi
c0031b3d:	e8 54 fb ff ff       	call   c0031696 <get_ucr3>
...
c0031c48:	c7 44 24 10 0f 8f 03 	movl   $0xc0038f0f,0x10(%esp)
c0031c4f:	c0 
c0031c50:	c7 44 24 0c 76 8f 03 	movl   $0xc0038f76,0xc(%esp)
c0031c57:	c0 
c0031c58:	c7 44 24 08 11 00 00 	movl   $0x11,0x8(%esp)
c0031c5f:	00 
c0031c60:	c7 44 24 04 fe 8e 03 	movl   $0xc0038efe,0x4(%esp)
c0031c67:	c0 
c0031c68:	c7 04 24 20 8f 03 c0 	movl   $0xc0038f20,(%esp)
c0031c6f:	e8 83 f5 ff ff       	call   c00311f7 <printk>
...
c0031c97:	c7 44 24 10 17 8f 03 	movl   $0xc0038f17,0x10(%esp)
c0031c9e:	c0 
c0031c9f:	c7 44 24 0c 76 8f 03 	movl   $0xc0038f76,0xc(%esp)
c0031ca6:	c0 
c0031ca7:	c7 44 24 08 13 00 00 	movl   $0x13,0x8(%esp)
c0031cae:	00 
c0031caf:	c7 44 24 04 fe 8e 03 	movl   $0xc0038efe,0x4(%esp)
c0031cb6:	c0 
c0031cb7:	c7 04 24 20 8f 03 c0 	movl   $0xc0038f20,(%esp)
c0031cbe:	e8 34 f5 ff ff       	call   c00311f7 <printk>
...
c0031cd7:	c7 44 24 10 0f 8f 03 	movl   $0xc0038f0f,0x10(%esp)
c0031cde:	c0 
c0031cdf:	c7 44 24 0c 76 8f 03 	movl   $0xc0038f76,0xc(%esp)
c0031ce6:	c0 
c0031ce7:	c7 44 24 08 11 00 00 	movl   $0x11,0x8(%esp)
c0031cee:	00 
c0031cef:	c7 44 24 04 fe 8e 03 	movl   $0xc0038efe,0x4(%esp)
c0031cf6:	c0 
c0031cf7:	c7 04 24 20 8f 03 c0 	movl   $0xc0038f20,(%esp)
c0031cfe:	e8 f4 f4 ff ff       	call   c00311f7 <printk>
...
c0031d28:	c7 44 24 10 17 8f 03 	movl   $0xc0038f17,0x10(%esp)
c0031d2f:	c0 
c0031d30:	c7 44 24 0c 76 8f 03 	movl   $0xc0038f76,0xc(%esp)
c0031d37:	c0 
c0031d38:	c7 44 24 08 13 00 00 	movl   $0x13,0x8(%esp)
c0031d3f:	00 
c0031d40:	c7 44 24 04 fe 8e 03 	movl   $0xc0038efe,0x4(%esp)
c0031d47:	c0 
c0031d48:	c7 04 24 20 8f 03 c0 	movl   $0xc0038f20,(%esp)
c0031d4f:	e8 a3 f4 ff ff       	call   c00311f7 <printk>
...
c0031d78:	c7 44 24 10 eb 8e 03 	movl   $0xc0038eeb,0x10(%esp)
c0031d7f:	c0 
c0031d80:	c7 44 24 0c 6c 8f 03 	movl   $0xc0038f6c,0xc(%esp)
c0031d87:	c0 
c0031d88:	c7 44 24 08 31 00 00 	movl   $0x31,0x8(%esp)
c0031d8f:	00 
c0031d90:	c7 44 24 04 fe 8e 03 	movl   $0xc0038efe,0x4(%esp)
c0031d97:	c0 
c0031d98:	c7 04 24 20 8f 03 c0 	movl   $0xc0038f20,(%esp)
c0031d9f:	e8 53 f4 ff ff       	call   c00311f7 <printk>
